...
for replacement_word in replacement_words:
    ...
    input_file = "/eos/user/s/sgiappic/2HNL_prod/HNL_6.67e-10/Events/{}/{}_tag_1_banner.txt".format(replacement_word, replacement_word)
    output_file = "/eos/user/s/sgiappic/2HNL_prod/HNL_6.67e-10/weights.txt"
