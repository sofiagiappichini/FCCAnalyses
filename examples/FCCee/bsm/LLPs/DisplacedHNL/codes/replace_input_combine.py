...
for replacement_word in replacement_words:
    ...
    shutil.copy("/eos/user/s/sgiappic/combine/datacard_final_june.txt", os.path.join(backup_dir, "datacard_backup.txt"))
    ...
    output_file = "/eos/user/s/sgiappic/combine/output_final_3june.csv"
