...
DIR_PLOTS = '/eos/user/s/sgiappic/www/paper/ratio/' 
...
ratio_leg = [
    "HNL_2.86e-12_30gev/HNL_6.67e-10_30gev",
    "HNL_2.86e-12_30gev/HNL_5e-12_60gev",
    "HNL_2.86e-12_30gev/HNL_1.33e-7_80gev",
]
    ...
    for variable in VARIABLES_ALL:
        ...
        for i in range(nsig):
            ...
            if i == 0:
                ...
                h.GetYaxis().SetRangeUser(1e-5,1e8) #range to set if only working with signals
