...
inputDir = "/ceph/awiedl/FCCee/HiggsCP/stage1_eff2_nocharge_cleanup/" 

#Optional: output directory, default is local running directory
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/final_eff2_nocharge_clean/" 
...
cutList = {
   ...
   "selTag1-5":"n_events_tag5==1",
   "selTag2-5":"n_events_tag5==2",
   "selTag0-5":"n_events_tag5==0",

   "selTag1":"n_events_tag==1",
   "selTag2":"n_events_tag==2",
   "selTag0":"n_events_tag==0",
   #"selTag":"n_events_tag>-1",
   "selTag1-5_mass":"n_events_tag5_mass==1",
   "selTag2-5_mass":"n_events_tag5_mass==2",
   "selTag0-5_mass":"n_events_tag5_mass==0",

   "selTag1_mass":"n_events_tag_mass==1",
   "selTag2_mass":"n_events_tag_mass==2",
   "selTag0_mass":"n_events_tag_mass==0",
   #"selTag_mass":"n_events_tag_mass>-1",
   "selFunc1":"n_events_func==1",
   "selFunc2":"n_events_func==2",
   "selFunc0":"n_events_func==0",
   #"selFunc":"n_events_func>-1",
...
cutLabels = {
    "selTag1-5":"Events with one taus (score$>$0.5)",
    "selTag2-5":"Events with two taus (score$>$0.5)",
    "selTag0-5":"Events with zero taus (score$>$0.5)",

    "selTag1":"Events with one taus (score$>$0.9)",
    "selTag2":"Events with two taus (score$>$0.9)",
    "selTag0":"Events with zero taus (score$>$0.9)",
    #"selTag":"Events with taus (score$>$0.5)",
    "selTag1-5_mass":"Events with one taus (score$>$0.5, M<3 GeV)",
    "selTag2-5_mass":"Events with two taus (score$>$0.5, M<3 GeV)",
    "selTag0-5_mass":"Events with zero taus (score$>$0.5, M<3 GeV)",

    "selTag1_mass":"Events with one taus (score$>$0.9, M<3 GeV)",
    "selTag2_mass":"Events with two taus (score$>$0.9, M<3 GeV)",
    "selTag0_mass":"Events with zero taus (score$>$0.9, M<3 GeV)",
    #"selTag_mass":"Events with taus (score$>$0.9, M<3 GeV)",
    "selFunc1":"Events with one tau from function",
    "selFunc2":"Events with two taus from function",
    "selFunc0":"Events with zero taus from function",
    #"selFunc":"Events with taus from function",
...
histoList = {
    ...
    "n_GenTau_had":                 {"name":"n_GenTau_had",     "title":"Number of gen hadronic taus",     "bin":5, "xmin":-0.5, "xmax":4.5},
    "n_TauTag_R5_match":             {"name":"n_TauTag_R5_match",     "title":"Number of reco hadronic taus with score>0.9",     "bin":5, "xmin":-0.5, "xmax":4.5},
    "n_TauTag_R5_mass_match":        {"name":"n_TauTag_R5_mass_match",     "title":"Number of reco hadronic taus with score>0.9 and M<3 GeV",     "bin":5, "xmin":-0.5, "xmax":4.5},
    "n_TauTag_R5_match5":             {"name":"n_TauTag_R5_match5",     "title":"Number of reco hadronic taus with score>0.9",     "bin":5, "xmin":-0.5, "xmax":4.5},
    "n_TauTag_R5_mass_match5":        {"name":"n_TauTag_R5_mass_match5",     "title":"Number of reco hadronic taus with score>0.9 and M<3 GeV",     "bin":5, "xmin":-0.5, "xmax":4.5},
    "n_events_tag":                 {"name":"n_events_tag",     "title":"Number of matches with tagged taus",     "bin":4, "xmin":-1.5, "xmax":2.5},
    "n_events_tag_mass":            {"name":"n_events_tag_mass",     "title":"Number of matches with tagged taus",     "bin":4, "xmin":-1.5, "xmax":2.5},
    "n_events_tag5":                 {"name":"n_events_tag5",     "title":"Number of matches with tagged taus",     "bin":4, "xmin":-1.5, "xmax":2.5},
    "n_events_tag5_mass":            {"name":"n_events_tag5_mass",     "title":"Number of matches with tagged taus",     "bin":4, "xmin":-1.5, "xmax":2.5},
    "n_events_func":                 {"name":"n_events_func",     "title":"Number of matches with tagged taus",     "bin":4, "xmin":-1.5, "xmax":2.5},
