    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion 
                ...
                .Define("TauTag_px",      "TagJet_kt3_px[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_py",      "TagJet_kt3_py[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_pz",      "TagJet_kt3_pz[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_pt",      "TagJet_kt3_pt[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_p",      "TagJet_kt3_p[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_e",      "TagJet_kt3_e[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_phi",      "TagJet_kt3_phi[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_eta",      "TagJet_kt3_eta[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_theta",      "TagJet_kt3_theta[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_charge",      "TagJet_kt3_charge[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_mass",      "TagJet_kt3_mass[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isG",      "TagJet_kt3_isG[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isU",      "TagJet_kt3_isU[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isD",      "TagJet_kt3_isD[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isS",      "TagJet_kt3_isS[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isC",      "TagJet_kt3_isC[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isB",      "TagJet_kt3_isB[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_isTAU",      "TagJet_kt3_isTAU[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("TauTag_flavor",      "TagJet_kt3_flavor[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("n_TauTag_constituents",        "n_TagJet_kt3_constituents[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("n_TauTag_charged_constituents",        "n_TagJet_kt3_charged_constituents[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("n_TauTag_neutral_constituents",        "n_TagJet_kt3_neutral_constituents[TagJet_kt3_isTAU>0.5 && abs(TagJet_kt3_charge)==1 && TagJet_kt3_mass<3]")
                .Define("n_TauTag",          "TauTag_px.size()")

                .Define("QuarkTag_px",      "TagJet_kt3_px[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_py",      "TagJet_kt3_py[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_pz",      "TagJet_kt3_pz[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_pt",      "TagJet_kt3_pt[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_p",      "TagJet_kt3_p[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_e",      "TagJet_kt3_e[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_phi",      "TagJet_kt3_phi[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_eta",      "TagJet_kt3_eta[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_theta",      "TagJet_kt3_theta[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_charge",      "TagJet_kt3_charge[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_mass",      "TagJet_kt3_mass[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isG",      "TagJet_kt3_isG[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isU",      "TagJet_kt3_isU[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isD",      "TagJet_kt3_isD[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isS",      "TagJet_kt3_isS[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isC",      "TagJet_kt3_isC[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isB",      "TagJet_kt3_isB[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_isTAU",      "TagJet_kt3_isTAU[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("QuarkTag_flavor",      "TagJet_kt3_flavor[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("n_QuarkTag_constituents",        "n_TagJet_kt3_constituents[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("n_QuarkTag_charged_constituents",        "n_TagJet_kt3_charged_constituents[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("n_QuarkTag_neutral_constituents",        "n_TagJet_kt3_neutral_constituents[TagJet_kt3_isTAU<=0.5 || abs(TagJet_kt3_charge)!=1 || TagJet_kt3_mass>=3]")
                .Define("n_QuarkTag",     "QuarkTag_charge.size()")

                #.Filter("n_TauFromJet_R5Tag==1 && n_RecoLeptons_sel==1 && n_TagJet_R5_sel==2")

                #.Filter("(TauFromJet_R5Tag_charge.at(0) + RecoLepton_sel_charge.at(0))==0") 

                #.Filter("(TagJet_R5_sel_charge.at(0) + TagJet_R5_sel_charge.at(1))==0") 

                ###############################

                .Filter("n_TauTag==1 && n_RecoLeptons_sel==1 && n_QuarkTag==2")

                .Filter("(TauTag_charge.at(0) + RecoLepton_sel_charge.at(0))==0") 
                #.Filter("(QuarkTag_charge.at(0) + QuarkTag_charge.at(1))==0") 

                ################################

                #.Filter("n_Jets_R5==3")

                #.Define("Electron_idx",       "FCCAnalyses::ZHfunctions::deltaR_sel_idx(RecoElectron_phi, Jets_R5_phi, RecoElectron_eta, Jets_R5_eta, 0.9)")
                #.Define("Muon_idx",       "FCCAnalyses::ZHfunctions::deltaR_sel_idx(RecoMuon_phi, Jets_R5_phi, RecoMuon_eta, Jets_R5_eta, 0.9)")
                ...
                .Define("TauP_p4","if (TauTag_charge.at(0)==1) return RecoTau2_p4; else return RecoTau1_p4;")
                ...
                .Define("TauP_type",     "if (TauTag_charge.at(0)==1) return RecoTau2_type; else return RecoTau1_type;")
                .Define("n_TauP_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau2_constituents; else return n_RecoTau1_constituents;")
                .Define("n_TauP_charged_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau2_charged_constituents; else return n_RecoTau1_charged_constituents;")
                .Define("n_TauP_neutral_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau2_neutral_constituents; else return n_RecoTau1_neutral_constituents;")

                .Define("TauM_p4",       "if (TauTag_charge.at(0)==1) return RecoTau1_p4; else return RecoTau2_p4;")
                ...
                .Define("TauM_type",     "if (TauTag_charge.at(0)==1) return RecoTau1_type; else return RecoTau2_type;")
                .Define("n_TauM_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau1_constituents; else return n_RecoTau2_constituents;")
                .Define("n_TauM_charged_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau1_charged_constituents; else return n_RecoTau2_charged_constituents;")
                .Define("n_TauM_neutral_constituents",     "if (TauTag_charge.at(0)==1) return n_RecoTau1_neutral_constituents; else return n_RecoTau2_neutral_constituents;")
