...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage2_241025_cut/NuNu/HH/" 
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                #.Filter("n_TauFromJet_kt2Tag==2 && n_TagJet_R5_sel==0 && n_RecoLeptons==0 && (TauFromJet_R5Tag_charge.at(0) + TauFromJet_R5Tag_charge.at(1))==0") 
