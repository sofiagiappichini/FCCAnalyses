...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage2_241025_cut/NuNu/LH/" 
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("TauTag_px",      "TagJet_kt1_px[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_py",      "TagJet_kt1_py[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_pz",      "TagJet_kt1_pz[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_pt",      "TagJet_kt1_pt[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_p",      "TagJet_kt1_p[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_e",      "TagJet_kt1_e[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_phi",      "TagJet_kt1_phi[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_eta",      "TagJet_kt1_eta[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_theta",      "TagJet_kt1_theta[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_charge",      "TagJet_kt1_charge[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_mass",      "TagJet_kt1_mass[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isG",      "TagJet_kt1_isG[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isU",      "TagJet_kt1_isU[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isD",      "TagJet_kt1_isD[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isS",      "TagJet_kt1_isS[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isC",      "TagJet_kt1_isC[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isB",      "TagJet_kt1_isB[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_isTAU",      "TagJet_kt1_isTAU[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("TauTag_flavor",      "TagJet_kt1_flavor[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("n_TauTag_constituents",        "n_TagJet_kt1_constituents[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("n_TauTag_charged_constituents",        "n_TagJet_kt1_charged_constituents[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("n_TauTag_neutral_constituents",        "n_TagJet_kt1_neutral_constituents[TagJet_kt1_isTAU>0.5 && abs(TagJet_kt1_charge)==1 && TagJet_kt1_mass<3]")
                .Define("n_TauTag",          "TauTag_px.size()")

                .Define("QuarkTag_px",      "TagJet_kt1_px[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_py",      "TagJet_kt1_py[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_pz",      "TagJet_kt1_pz[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_pt",      "TagJet_kt1_pt[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_p",      "TagJet_kt1_p[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_e",      "TagJet_kt1_e[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_phi",      "TagJet_kt1_phi[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_eta",      "TagJet_kt1_eta[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_theta",      "TagJet_kt1_theta[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_charge",      "TagJet_kt1_charge[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_mass",      "TagJet_kt1_mass[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isG",      "TagJet_kt1_isG[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isU",      "TagJet_kt1_isU[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isD",      "TagJet_kt1_isD[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isS",      "TagJet_kt1_isS[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isC",      "TagJet_kt1_isC[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isB",      "TagJet_kt1_isB[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_isTAU",      "TagJet_kt1_isTAU[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("QuarkTag_flavor",      "TagJet_kt1_flavor[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("n_QuarkTag_constituents",        "n_TagJet_kt1_constituents[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("n_QuarkTag_charged_constituents",        "n_TagJet_kt1_charged_constituents[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("n_QuarkTag_neutral_constituents",        "n_TagJet_kt1_neutral_constituents[TagJet_kt1_isTAU<=0.5 || abs(TagJet_kt1_charge)!=1 || TagJet_kt1_mass>=3]")
                .Define("n_QuarkTag",     "QuarkTag_charge.size()")

                ### defining filters for one lepton and one hadronic tau

                #.Filter("n_RecoLeptons==1 && n_Jets_R5_sel==0 && n_TauFromJet_R5==1 && (RecoLepton_charge.at(0) + TauFromJet_R5_charge.at(0))==0") 

                #########################

                .Filter("n_TauTag==1 && n_QuarkTag==0 && n_RecoLeptons_sel==1") 
                ...
                #.Filter("(Electron_idx.size()==1 && Muon_idx.size()==0) || (Muon_idx.size()==1 && Electron_idx.size()==0)")
