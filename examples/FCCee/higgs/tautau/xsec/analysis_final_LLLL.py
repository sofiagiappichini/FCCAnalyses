...
outputDir = "/ceph/sgiappic/HiggsCP/final/LL/LL/" #your final directory
...
cutList = {
    ...
    "selReco": "(TauFromJet_type[0]>=0 && TauFromJet_type[1]>=0)",
    "selReco_Maria": "(RecoLepton_pt[0]>10 && RecoLepton_pt[1]>10) && (Recoil>120 && Recoil<140) && (RecoEmiss_costheta<0.98) && (TauFromJet_pt[0]>10 && TauFromJet_pt[1]>10) && (TauFromJet_type[0]>=0 && TauFromJet_type[1]>=0)",
}
...
histoList = {
    ...
    "FSRGenTau_e":                      {"name":"FSRGenTau_e",                  "title":"Final state gen taus energy [GeV]",           "bin":100, "xmin":0, "xmax":50},
    "FSRGenTau_p":                      {"name":"FSRGenTau_p",                  "title":"Final state gen taus p [GeV]",                "bin":100, "xmin":0 ,"xmax":50},
    "FSRGenTau_pt":                     {"name":"FSRGenTau_pt",                 "title":"Final state gen taus p_{T} [GeV]",            "bin":100, "xmin":0 ,"xmax":50},
    "FSRGenTau_px":                     {"name":"FSRGenTau_px",                 "title":"Final state gen taus p_{x} [GeV]",            "bin":100, "xmin":0 ,"xmax":50},
    "FSRGenTau_py":                     {"name":"FSRGenTau_py",                 "title":"Final state gen taus p_{y} [GeV]",            "bin":100, "xmin":0 ,"xmax":50},
    "FSRGenTau_pz":                     {"name":"FSRGenTau_pz",                 "title":"Final state gen taus p_{z} [GeV]",            "bin":100, "xmin":0 ,"xmax":50},
