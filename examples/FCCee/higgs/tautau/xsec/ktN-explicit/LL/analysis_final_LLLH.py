...
inputDir = "/ceph/awiedl/FCCee/HiggsCP/ktN-explicit/stage2_241125/LL/LH/"

#Optional: output directory, default is local running directory
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/ktN-explicit/final_241125/LL/LH/" 
...
cutList = {
    ...
    "selReco_100Coll150_115Rec160_10Me_70Z100_2DR_cos0.6": "Collinear_mass>100 && Collinear_mass<150 && Recoil>115 && Recoil<160 && RecoEmiss_e>10 && RecoZ_mass>70 && RecoZ_mass<100 && Tau_DR>2 && Tau_cos<-0.6",
    "selReco_100Coll150_115Rec160_10Me_70Z100_2DR_cos0.6_misscos0.98": "Collinear_mass>100 && Collinear_mass<150 && Recoil>115 && Recoil<160 && RecoEmiss_e>10 && RecoZ_mass>70 && RecoZ_mass<100 && Tau_DR>2 && Tau_cos<-0.6 && RecoEmiss_costheta<0.98",
...
cutLabels = {
    ...
    "selReco_100Coll150_115Rec160_10Me_70Z100_2DR_cos0.6": "100<M_{collinear}<150 GeV, 115<M_{recoil}<160 GeV, E_{miss}>10 GeV, 70<M_{Z}<110 GeV, #Delta R_{#tau}>2, cos#theta_{#tau}<0",
    "selReco_100Coll150_115Rec160_10Me_70Z100_2DR_cos0.6_misscos0.98": "100<M_{collinear}<150 GeV, 115<M_{recoil}<160 GeV, E_{miss}>10 GeV, 70<M_{Z}<110 GeV, #Delta R_{#tau}>2, cos#theta_{#tau}<0, |cos#theta_{miss}|<0.98",
