...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage2_eff_cat/LL/LH/" 
    ...
    def analysers(df):
        df2 = (df
            ...
            ### defining filters for 3 lepton final state based on flavor combination: 3 same flavor, 1 pair, all plus one hadronic taus
                ...
                .Define("ThreeLeptons",    "(((n_RecoElectrons_sel==3 and n_RecoMuons_sel==0) or (n_RecoElectrons_sel==0 and n_RecoMuons_sel==3)) and (RecoLepton_sel_charge.at(0) + RecoLepton_sel_charge.at(1) + RecoLepton_sel_charge.at(2) + TauTag_charge.at(0))==0)*1.0")
                .Define("OnePair",     "((n_RecoElectrons_sel==2 and n_RecoMuons_sel==1 and (RecoElectron_sel_charge.at(0) + RecoElectron_sel_charge.at(1))==0 and (RecoMuon_sel_charge.at(0) + TauTag_charge.at(0))==0) or (n_RecoElectrons_sel==1 and n_RecoMuons_sel==2 and (RecoMuon_sel_charge.at(0) + RecoMuon_sel_charge.at(1))==0 and (RecoElectron_sel_charge.at(0) + TauTag_charge.at(0))==0))*1.0")
                ...
                .Define("RecoZ1_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(RecoLepton_sel_px.at(RecoZH_idx[0]), RecoLepton_sel_py.at(RecoZH_idx[0]), RecoLepton_sel_pz.at(RecoZH_idx[0]), RecoLepton_sel_e.at(RecoZH_idx[0]))")
                .Define("RecoZ2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(RecoLepton_sel_px.at(RecoZH_idx[1]), RecoLepton_sel_py.at(RecoZH_idx[1]), RecoLepton_sel_pz.at(RecoZH_idx[1]), RecoLepton_sel_e.at(RecoZH_idx[1]))")
                ...
                .Define("RecoTau1_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(RecoLepton_sel_px.at(RecoZH_idx[2]), RecoLepton_sel_py.at(RecoZH_idx[2]), RecoLepton_sel_pz.at(RecoZH_idx[2]), RecoLepton_sel_e.at(RecoZH_idx[2]))")
