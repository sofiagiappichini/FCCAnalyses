...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage2_tag_exp/LL/LH/" 
    ...
    def analysers(df):
        df2 = (df
            ...
            ### defining filters for 3 lepton final state based on flavor combination: 3 same flavor, 1 pair, all plus one hadronic taus
                ...
                #.Filter("n_Tau_r5Tag==1 && n_TagJet_R5[TagJet_isTAU<0.5]==0")
                ...
                .Define("RecoTau2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TauFromJet_R5Tag_px.at(0), TauFromJet_R5Tag_py.at(0), TauFromJet_R5Tag_pz.at(0), TauFromJet_R5Tag_e.at(0))")
                ...
                .Define("TauP_p4","if (TauFromJet_R5Tag_charge.at(0)==1) return RecoTau2_p4; else return RecoTau1_p4;")
                ...
                .Define("TauM_p4",       "if (TauFromJet_R5Tag_charge.at(0)==1) return RecoTau1_p4; else return RecoTau2_p4;")
