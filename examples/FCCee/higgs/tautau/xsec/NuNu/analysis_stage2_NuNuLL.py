...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage2_tag_241025/NuNu/LL/" 
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Filter("n_TauTag==0 && n_QuarkTag==0 && OnePair==1") 
                ...
                .Define("RecoTau2_type",        "if (RecoLepton_mass.at(0)<0.05) return float(-0.13); else return float(-0.11);")
                ...
                .Define("TauP_p4","if (RecoLepton_charge.at(0)==1) return RecoTau1_p4; else return RecoTau2_p4;")
                ...
                .Define("n_TauP_constituents",     "if (RecoLepton_charge.at(0)==1) return n_RecoTau1_constituents; else return n_RecoTau2_constituents;")
                .Define("n_TauP_charged_constituents",     "if (RecoLepton_charge.at(0)==1) return n_RecoTau1_charged_constituents; else return n_RecoTau2_charged_constituents;")
                .Define("n_TauP_neutral_constituents",     "if (RecoLepton_charge.at(0)==1) return n_RecoTau1_neutral_constituents; else return n_RecoTau2_neutral_constituents;")
