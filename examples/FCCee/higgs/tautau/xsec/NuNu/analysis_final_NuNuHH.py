...
inputDir = "/ceph/awiedl/FCCee/HiggsCP/stage2_tag/NuNu/HH/"

#Optional: output directory, default is local running directory
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/final_tag/NuNu/HH/" 
...
histoList = {
    ...
    "Jets_R5_e":                {"name":"Jets_R5_e",                   "title":"R5 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},   
    "Jets_R5_p":                {"name":"Jets_R5_p",                   "title":"R5 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "Jets_R5_pt":               {"name":"Jets_R5_pt",                  "title":"R5 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "Jets_R5_px":               {"name":"Jets_R5_px",                  "title":"R5 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_py":               {"name":"Jets_R5_py",                  "title":"R5 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_pz":               {"name":"Jets_R5_pz",                  "title":"R5 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_eta":              {"name":"Jets_R5_eta",                 "title":"R5 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_theta":            {"name":"Jets_R5_theta",               "title":"R5 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "Jets_R5_phi":              {"name":"Jets_R5_phi",                 "title":"R5 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_mass":             {"name":"Jets_R5_mass",                "title":"R5 jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "n_Jets_R5":                {"name":"n_Jets_R5",                   "title":"Number of R5 jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},
                                
    "Jets_R5_sel_e":            {"name":"Jets_R5_sel_e",                   "title":"not hadronic #tau R5 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},    
    "Jets_R5_sel_p":            {"name":"Jets_R5_sel_p",                   "title":"not hadronic #tau R5 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "Jets_R5_sel_pt":           {"name":"Jets_R5_sel_pt",                  "title":"not hadronic #tau R5 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "Jets_R5_sel_px":           {"name":"Jets_R5_sel_px",                  "title":"not hadronic #tau R5 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_sel_py":           {"name":"Jets_R5_sel_py",                  "title":"not hadronic #tau R5 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_sel_pz":           {"name":"Jets_R5_sel_pz",                  "title":"not hadronic #tau R5 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "Jets_R5_sel_eta":          {"name":"Jets_R5_sel_eta",                 "title":"not hadronic #tau R5 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_sel_theta":        {"name":"Jets_R5_sel_theta",               "title":"not hadronic #tau R5 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "Jets_R5_sel_phi":          {"name":"Jets_R5_sel_phi",                 "title":"not hadronic #tau R5 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_sel_mass":         {"name":"Jets_R5_sel_mass",                "title":"not hadronic #tau R5 jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "n_Jets_R5_sel":            {"name":"n_Jets_R5_sel",                   "title":"Number of not hadronic #tau R5 jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},
    ...
    "TagJet_isG":             {"name":"TagJet_isG",                "title":"R5 jet G score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isU":             {"name":"TagJet_isU",                "title":"R5 jet U score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isD":             {"name":"TagJet_isD",                "title":"R5 jet D score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isS":             {"name":"TagJet_isS",                "title":"R5 jet S score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isC":             {"name":"TagJet_isC",                "title":"R5 jet C score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isB":             {"name":"TagJet_isB",                "title":"R5 jet B score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isTAU":             {"name":"TagJet_isTAU",                "title":"R5 jet TAU score",                     "bin":100, "xmin":0., "xmax":1.},

    "TauFromJet_R5Tag_p":          {"name":"TauFromJet_R5Tag_p",                   "title":"#tau from R5 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_pt":         {"name":"TauFromJet_R5Tag_pt",                  "title":"#tau from R5 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_px":         {"name":"TauFromJet_R5Tag_px",                  "title":"#tau from R5 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_py":         {"name":"TauFromJet_R5Tag_py",                  "title":"#tau from R5 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_pz":         {"name":"TauFromJet_R5Tag_pz",                  "title":"#tau from R5 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_theta":      {"name":"TauFromJet_R5Tag_theta",               "title":"#tau from R5 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "TauFromJet_R5Tag_phi":        {"name":"TauFromJet_R5Tag_phi",                 "title":"#tau from R5 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TauFromJet_R5Tag_e":          {"name":"TauFromJet_R5Tag_e",                   "title":"#tau from R5 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_eta":        {"name":"TauFromJet_R5Tag_eta",                 "title":"#tau from R5 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TauFromJet_R5Tag_y":          {"name":"TauFromJet_R5Tag_y",                   "title":"#tau from R5 jet rapidity",                       "bin":80,"xmin":-4. ,"xmax":4.},
    "TauFromJet_R5Tag_charge":     {"name":"TauFromJet_R5Tag_charge",              "title":"#tau from R5 jet charge",                         "bin":3, "xmin":-1.5,"xmax":1.5},
    "TauFromJet_R5Tag_type":       {"name":"TauFromJet_R5Tag_type",                "title":"#tau from R5 jet decay type",                     "bin":100, "xmin":-20, "xmax":80},
    "TauFromJet_R5Tag_mass":       {"name":"TauFromJet_R5Tag_mass",                "title":"#tau from R5 jet mass [GeV]",                     "bin":15, "xmin":0., "xmax":3.},
    "n_TauFromJet_R5Tag":          {"name":"n_TauFromJet_R5Tag",                   "title":"Number of #tau from R5 jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},

    "TagJet_R5_sel_e":                {"name":"TagJet_R5_sel_e",                   "title":"R5 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},   
    "TagJet_R5_sel_p":                {"name":"TagJet_R5_sel_p",                   "title":"R5 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_sel_pt":               {"name":"TagJet_R5_sel_pt",                  "title":"R5 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_sel_px":               {"name":"TagJet_R5_sel_px",                  "title":"R5 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_py":               {"name":"TagJet_R5_sel_py",                  "title":"R5 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_pz":               {"name":"TagJet_R5_sel_pz",                  "title":"R5 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_eta":              {"name":"TagJet_R5_sel_eta",                 "title":"R5 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_sel_theta":            {"name":"TagJet_R5_sel_theta",               "title":"R5 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "TagJet_R5_sel_phi":              {"name":"TagJet_R5_sel_phi",                 "title":"R5 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_sel_mass":             {"name":"TagJet_R5_sel_mass",                "title":"R5 jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "n_TagJet_R5_sel":                {"name":"n_TagJet_R5_sel",                   "title":"Number of R5 jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},
    ...
    "TauTag_mass":             {"name":"TauTag_mass",                "title":"#tau from tagged jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "n_TauTag":                {"name":"n_TauTag",                   "title":"Number of #tau from tagged jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},

    "TauTag_isG":             {"name":"TauTag_isG",                "title":"#tau from tagged jet G score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isU":             {"name":"TauTag_isU",                "title":"#tau from tagged jet U score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isD":             {"name":"TauTag_isD",                "title":"#tau from tagged jet D score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isC":             {"name":"TauTag_isC",                "title":"#tau from tagged jet C score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isS":             {"name":"TauTag_isS",                "title":"#tau from tagged jet S score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isB":             {"name":"TauTag_isB",                "title":"#tau from tagged jet B score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "TauTag_isTAU":             {"name":"TauTag_isU",                "title":"#tau from tagged jet TAU score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    ...
    "QuarkTag_isG":             {"name":"QuarkTag_isG",                "title":"Quark jet from tagged jet G score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isU":             {"name":"QuarkTag_isU",                "title":"Quark jet from tagged jet U score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isD":             {"name":"QuarkTag_isD",                "title":"Quark jet from tagged jet D score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isC":             {"name":"QuarkTag_isC",                "title":"Quark jet from tagged jet C score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isS":             {"name":"QuarkTag_isS",                "title":"Quark jet from tagged jet S score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isB":             {"name":"QuarkTag_isB",                "title":"Quark jet from tagged jet B score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    "QuarkTag_isTAU":             {"name":"QuarkTag_isU",                "title":"Quark jet from tagged jet TAU score [GeV]",                     "bin":100, "xmin":0., "xmax":1.},
    ...
    "TauLead_type":             {"name":"TauLead_type",               "title":"#tau_{leading} type",                   "bin":140, "xmin":-13., "xmax":1.},
    ...
    "TauSub_type":              {"name":"TauSub_type",               "title":"#tau_{subleading} type",                   "bin":140, "xmin":-13., "xmax":1.},
    ...
    "TauP_type":             {"name":"TauP_type",               "title":"#tau^{+} type",                   "bin":140, "xmin":-13., "xmax":1.},
    ...
    "TauM_type":                {"name":"TauM_type",               "title":"#tau^{-} type",                   "bin":140, "xmin":-13., "xmax":1.},
