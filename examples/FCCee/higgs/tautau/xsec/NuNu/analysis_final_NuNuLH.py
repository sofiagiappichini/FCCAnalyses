...
histoList = {
    ...
    "TagJet_R5_e":                {"name":"TagJet_R5_e",                   "title":"Jets_{R5} energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},   
    "TagJet_R5_p":                {"name":"TagJet_R5_p",                   "title":"Jets_{R5} p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_pt":               {"name":"TagJet_R5_pt",                  "title":"Jets_{R5} p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_px":               {"name":"TagJet_R5_px",                  "title":"Jets_{R5} p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_py":               {"name":"TagJet_R5_py",                  "title":"Jets_{R5} p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_pz":               {"name":"TagJet_R5_pz",                  "title":"Jets_{R5} p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_eta":              {"name":"TagJet_R5_eta",                 "title":"Jets_{R5} #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_theta":            {"name":"TagJet_R5_theta",               "title":"Jets_{R5} #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "TagJet_R5_phi":              {"name":"TagJet_R5_phi",                 "title":"Jets_{R5} #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_mass":             {"name":"TagJet_R5_mass",                "title":"Jets_{R5} mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "TagJet_R5_charge":             {"name":"TagJet_R5_charge",                "title":"Jets_{R5} charge",                     "bin":10, "xmin":-5., "xmax":5.},
    "n_TagJet_R5":                {"name":"n_TagJet_R5",                   "title":"Number of Jets_{R5}",                     "bin":5, "xmin":-0.5, "xmax":4.5},
    "TagJet_isU":             {"name":"TagJet_isU",                "title":"Jets_{R5} U score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isD":             {"name":"TagJet_isD",                "title":"Jets_{R5} D score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isS":             {"name":"TagJet_isS",                "title":"Jets_{R5} S score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isC":             {"name":"TagJet_isC",                "title":"Jets_{R5} C score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isB":             {"name":"TagJet_isB",                "title":"Jets_{R5} B score",                     "bin":100, "xmin":0., "xmax":1.},
    "TagJet_isTAU":             {"name":"TagJet_isTAU",                "title":"Jets_{R5} TAU score",                     "bin":100, "xmin":0., "xmax":1.},

    "TauFromJet_R5Tag_p":          {"name":"TauFromJet_R5Tag_p",                   "title":"#tau from jet_{R5} p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_pt":         {"name":"TauFromJet_R5Tag_pt",                  "title":"#tau from jet_{R5} p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_px":         {"name":"TauFromJet_R5Tag_px",                  "title":"#tau from jet_{R5} p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_py":         {"name":"TauFromJet_R5Tag_py",                  "title":"#tau from jet_{R5} p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_pz":         {"name":"TauFromJet_R5Tag_pz",                  "title":"#tau from jet_{R5} p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_R5Tag_theta":      {"name":"TauFromJet_R5Tag_theta",               "title":"#tau from jet_{R5} #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "TauFromJet_R5Tag_phi":        {"name":"TauFromJet_R5Tag_phi",                 "title":"#tau from jet_{R5} #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TauFromJet_R5Tag_e":          {"name":"TauFromJet_R5Tag_e",                   "title":"#tau from jet_{R5} energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_R5Tag_eta":        {"name":"TauFromJet_R5Tag_eta",                 "title":"#tau from jet_{R5} #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TauFromJet_R5Tag_y":          {"name":"TauFromJet_R5Tag_y",                   "title":"#tau from jet_{R5} rapidity",                       "bin":80,"xmin":-4. ,"xmax":4.},
    "TauFromJet_R5Tag_charge":     {"name":"TauFromJet_R5Tag_charge",              "title":"#tau from jet_{R5} charge",                         "bin":3, "xmin":-1.5,"xmax":1.5},
    "TauFromJet_R5Tag_type":       {"name":"TauFromJet_R5Tag_type",                "title":"#tau from jet_{R5} decay type",                     "bin":100, "xmin":-20, "xmax":80},
    "TauFromJet_R5Tag_mass":       {"name":"TauFromJet_R5Tag_mass",                "title":"#tau from jet_{R5} mass [GeV]",                     "bin":15, "xmin":0., "xmax":3.},
    "n_TauFromJet_R5Tag":          {"name":"n_TauFromJet_R5Tag",                   "title":"Number of #tau from Jets_{R5}",                     "bin":5, "xmin":-0.5, "xmax":4.5},

    "TagJet_R5_sel_e":                {"name":"TagJet_R5_sel_e",                   "title":"Jets_{R5} energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},   
    "TagJet_R5_sel_p":                {"name":"TagJet_R5_sel_p",                   "title":"Jets_{R5} p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_sel_pt":               {"name":"TagJet_R5_sel_pt",                  "title":"Jets_{R5} p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TagJet_R5_sel_px":               {"name":"TagJet_R5_sel_px",                  "title":"Jets_{R5} p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_py":               {"name":"TagJet_R5_sel_py",                  "title":"Jets_{R5} p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_pz":               {"name":"TagJet_R5_sel_pz",                  "title":"Jets_{R5} p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TagJet_R5_sel_eta":              {"name":"TagJet_R5_sel_eta",                 "title":"Jets_{R5} #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_sel_theta":            {"name":"TagJet_R5_sel_theta",               "title":"Jets_{R5} #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    "TagJet_R5_sel_phi":              {"name":"TagJet_R5_sel_phi",                 "title":"Jets_{R5} #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_sel_mass":             {"name":"TagJet_R5_sel_mass",                "title":"Jets_{R5} mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    "n_TagJet_R5_sel":                {"name":"n_TagJet_R5_sel",                   "title":"Number of Jets_{R5}",                     "bin":5, "xmin":-0.5, "xmax":4.5},
