...
output = '/work/sgiappic/HTCondor/stage1_241125/' ##output directory of submission files, needs to be different to have unique submission files
outputDir = '/ceph/awiedl/FCCee/HiggsCP/stage1_241125/' ##output directory of stage2 samples
