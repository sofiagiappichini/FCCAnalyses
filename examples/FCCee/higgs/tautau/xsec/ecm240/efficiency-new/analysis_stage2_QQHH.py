...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("TauTag_p_kt4",      "TagJet_kt4_p[TagJet_kt4_isTAU>0.5]")
                ...
                .Define("TauTag_kt4_Gen_p",       "FCCAnalyses::ZHfunctions::deltaR_sel_diff(TauTag_p_kt4, HadGenTau_p, TauTag_phi_kt4, HadGenTau_phi, TauTag_eta_kt4, HadGenTau_eta, 0.2)")
