...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("RecoZP_PID",       "if (RecoLepton_mass.at(RecoZH_idx[0])<8e-4) return (-11); else return (-13);")
                ...
                .Define("RecoZM_PID",       "if (RecoLepton_mass.at(RecoZH_idx[0])<8e-4) return (11); else return (13);")
                ...
                .Define("TauP_DM",       "if (TauP_mass<8e-4) return (-11); else return (-13);")
                ...
                .Define("TauM_DM",       "if (TauM_mass<8e-4) return (-11); else return (-13);")
