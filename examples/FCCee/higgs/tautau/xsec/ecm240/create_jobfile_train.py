    ...
    for tag in TAG:
        for cat in CAT:
            for sub in SUB:
                ...
                scr += f"python /afs/cern.ch/user/s/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm240/BDT/training-new/{tag}/train_bdt_{cat}{sub}.py"
                scr += '\n\n'     
...
output = '/afs/cern.ch/user/s/sgiappic/HTCondor/training_240/' ##output directory of submission files, needs to be different to have unique submission files
