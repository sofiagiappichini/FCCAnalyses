...
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/detector_studies/ecm240/stage2_CMS2/QQ/LL/" 
...
#                .Define("RecoMuonTrack_sel_Z0cov", "ReconstructedParticle2Track::getRP2TRK_Z0_cov(RecoMuons_sel,EFlowTrack_1)")
        ...
        df2 =(df2
                ...
                .Define("TauLeptons_smeared",        "FCCAnalyses::ZHfunctions::Find_LeadingPair(RecoLeptons_sel_smeared)")

                .Define("n_TauLeptons_smeared",      "ReconstructedParticle::get_n(TauLeptons_smeared)")
                .Define("TauLeptons_e_smeared",      "ReconstructedParticle::get_e(TauLeptons_smeared)")
                .Define("TauLeptons_p_smeared",      "ReconstructedParticle::get_p(TauLeptons_smeared)")
                .Define("TauLeptons_pt_smeared",      "ReconstructedParticle::get_pt(TauLeptons_smeared)")
                .Define("TauLeptons_px_smeared",      "ReconstructedParticle::get_px(TauLeptons_smeared)")
                .Define("TauLeptons_py_smeared",      "ReconstructedParticle::get_py(TauLeptons_smeared)")
                .Define("TauLeptons_pz_smeared",      "ReconstructedParticle::get_pz(TauLeptons_smeared)")
                .Define("TauLeptons_y_smeared",      "ReconstructedParticle::get_y(TauLeptons_smeared)")
                .Define("TauLeptons_eta_smeared",     "ReconstructedParticle::get_eta(TauLeptons_smeared)") #pseudorapidity eta
                .Define("TauLeptons_theta_smeared",   "ReconstructedParticle::get_theta(TauLeptons_smeared)")
                .Define("TauLeptons_phi_smeared",     "ReconstructedParticle::get_phi(TauLeptons_smeared)") #polar angle in the transverse plane phi
                .Define("TauLeptons_charge_smeared",  "ReconstructedParticle::get_charge(TauLeptons_smeared)")
                .Define("TauLeptons_mass_smeared",     "ReconstructedParticle::get_mass(TauLeptons_smeared)")

                .Define("LeadingLepton_e_smeared",      "TauLeptons_e_smeared.at(0)")
                .Define("LeadingLepton_p_smeared",      "TauLeptons_p_smeared.at(0)")
                .Define("LeadingLepton_pt_smeared",      "TauLeptons_pt_smeared.at(0)")
                .Define("LeadingLepton_px_smeared",      "TauLeptons_px_smeared.at(0)")
                .Define("LeadingLepton_py_smeared",      "TauLeptons_py_smeared.at(0)")
                .Define("LeadingLepton_pz_smeared",      "TauLeptons_pz_smeared.at(0)")
                .Define("LeadingLepton_y_smeared",      "TauLeptons_y_smeared.at(0)")
                .Define("LeadingLepton_eta_smeared",     "TauLeptons_eta_smeared.at(0)") #pseudorapidity eta
                .Define("LeadingLepton_theta_smeared",   "TauLeptons_theta_smeared.at(0)")
                .Define("LeadingLepton_phi_smeared",     "TauLeptons_phi_smeared.at(0)") #polar angle in the transverse plane phi
                .Define("LeadingLepton_charge_smeared",  "TauLeptons_charge_smeared.at(0)")
                .Define("LeadingLepton_mass_smeared",     "TauLeptons_mass_smeared.at(0)")

                .Define("SubleadingLepton_e_smeared",      "TauLeptons_e_smeared.at(1)")
                .Define("SubleadingLepton_p_smeared",      "TauLeptons_p_smeared.at(1)")
                .Define("SubleadingLepton_pt_smeared",      "TauLeptons_pt_smeared.at(1)")
                .Define("SubleadingLepton_px_smeared",      "TauLeptons_px_smeared.at(1)")
                .Define("SubleadingLepton_py_smeared",      "TauLeptons_py_smeared.at(1)")
                .Define("SubleadingLepton_pz_smeared",      "TauLeptons_pz_smeared.at(1)")
                .Define("SubleadingLepton_y_smeared",      "TauLeptons_y_smeared.at(1)")
                .Define("SubleadingLepton_eta_smeared",     "TauLeptons_eta_smeared.at(1)") #pseudorapidity eta
                .Define("SubleadingLepton_theta_smeared",   "TauLeptons_theta_smeared.at(1)")
                .Define("SubleadingLepton_phi_smeared",     "TauLeptons_phi_smeared.at(1)") #polar angle in the transverse plane phi
                .Define("SubleadingLepton_charge_smeared",  "TauLeptons_charge_smeared.at(1)")
                .Define("SubleadingLepton_mass_smeared",     "TauLeptons_mass_smeared.at(1)")

                .Filter("n_TauLeptons_smeared==2") #making sure the pair is found
        ...
        df2 = (df2
                ...
                .Define("TauFromJet_kt2", "FCCAnalyses::ZHfunctions::findTauInJet_smearing({}, ReconstructedParticles, reco_mc_index, Particle, 21.7,3.5631, 1.2671, 18.3)".format(jetClusteringHelper_kt2.constituents)) 
        ...
        df2 = (df2
                ...
                .Filter("n_TauFromJet_kt2==0 && n_TagJet_kt2_sel==2 && n_RecoLeptons_sel==2")
                # no need to filter on the charges of the leading and subleading because they are built opposite anyway
                ...
                .Define("RecoTau1_p4",      "TLorentzVector(LeadingLepton_px_smeared, LeadingLepton_py_smeared, LeadingLepton_pz_smeared, LeadingLepton_e_smeared)")
                .Define("RecoTau2_p4",      "TLorentzVector(SubleadingLepton_px_smeared, SubleadingLepton_py_smeared, SubleadingLepton_pz_smeared, SubleadingLepton_e_smeared)")
                .Define("RecoTau1_type",        "if (LeadingLepton_mass_smeared<0.05) return float(-0.11); else return float(-0.13);")
                .Define("RecoTau2_type",        "if (SubleadingLepton_mass_smeared<0.05) return float(-0.13); else return float(-0.11);")
                ...
                .Define("TauP_p4","if (LeadingLepton_charge==1) return RecoTau1_p4; else return RecoTau2_p4;")
                ...
                .Define("TauP_type","if (LeadingLepton_charge==1) return RecoTau1_type; else return RecoTau2_type;")

                .Define("TauM_p4",       "if (LeadingLepton_charge==1) return RecoTau2_p4; else return RecoTau1_p4;")
                ...
                .Define("TauM_type","if (LeadingLepton_charge==1) return RecoTau2_type; else return RecoTau1_type;")
