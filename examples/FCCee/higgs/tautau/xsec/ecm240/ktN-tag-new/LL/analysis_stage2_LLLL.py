...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/stage1_250302/LL/LL/"
...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                .Define("jets_p4",             "FCCAnalyses::ZHfunctions::smear_jet({}, 2.55556)".format(jetClusteringHelper_R5.jets))
