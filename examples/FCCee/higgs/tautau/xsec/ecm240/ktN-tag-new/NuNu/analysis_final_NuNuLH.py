...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/final_250502/ktN-tag/NuNu/LH/"
...
cutList = {
    ...
    "selReco": "true",
    "selReco_100Me": "RecoEmiss_e>100 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_100Me_TauDPhi3": "RecoEmiss_e>100 && abs(Tau_DPhi)<3 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_100Me_TauDPhi3_2DR": "RecoEmiss_e>100 && abs(Tau_DPhi)<3 && Tau_DR>2 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_100Me_TauDPhi3_2DR_cos0.4": "RecoEmiss_e>100 && abs(Tau_DPhi)<3 && Tau_DR>2 && Tau_cos<-0.4 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_100Me_TauDPhi3_2DR_cos0.4_misscos0.98": "RecoEmiss_e>100 && abs(Tau_DPhi)<3 && Tau_DR>2 && Tau_cos<-0.4 && RecoEmiss_costheta<0.98 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_100Me_TauDPhi3_2DR_cos0.4_misscos0.98_missy1": "RecoEmiss_e>100 && abs(Tau_DPhi)<3 && Tau_DR>2 && Tau_cos<-0.4 && RecoEmiss_costheta<0.98 && abs(RecoEmiss_y)<1 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
