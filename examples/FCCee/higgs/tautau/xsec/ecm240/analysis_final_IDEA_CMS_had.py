...
histoList = {
    ...
    "NHadron_low_dR_MCPDG_2":                      {"name":"NHadron_low_dR_MCPDG",                      "title":"MC PDG of neutral hadrons with dR < 0.01 to there MC",          "bin":100,"xmin":2000 ,"xmax":2100},
    ...
    "jet_reso":                         {"name":"jet_reso",             "title":"p_{jet}-p_{genbquark}/p_{genbquark}",    "bin":500, "xmin":-0.5, "xmax":0.5},
}