...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/stage1_250502/ktN-explicit/QQ/HH/"

out = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/BDT_250502/ktN-explicit/"
output_file = out + "/output_QQHH.txt"
...
joblib.dump(df_train, out + 'train_data_ktN-explicit_QQHH.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-explicit_QQHH.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-explicit_QQHH.joblib")
