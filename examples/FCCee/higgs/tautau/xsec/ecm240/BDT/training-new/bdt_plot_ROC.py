...
output_file = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/BDT_250502/output_overtraining.txt"
...
for tag in TAG:
    ...
    # Save the figure
    fig.savefig(f"{modelDir}/{tag}/BDT_ROC.pdf")
    fig.savefig(f"{modelDir}/{tag}/BDT_ROC.png")