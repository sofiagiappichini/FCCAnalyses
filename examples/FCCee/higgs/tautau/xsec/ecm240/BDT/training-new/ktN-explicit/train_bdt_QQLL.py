...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/stage1_250502/ktN-explicit/QQ/LL/"

out = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/BDT_250502/ktN-explicit/"
output_file = out + "/output_QQLL.txt"
...
joblib.dump(df_train, out + 'train_data_ktN-explicit_QQLL.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-explicit_QQLL.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-explicit_QQLL.joblib")
