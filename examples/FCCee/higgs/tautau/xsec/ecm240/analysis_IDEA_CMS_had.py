...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = (df2
                #.Redefine(collections_res["PFParticles"],ROOT.SmearObjects.SmearedReconstructedParticle(190.50382, 0, 1, False),[collections["PFParticles"], "reco_mc_index", collections["GenParticles"]]) # 15.68643
                #.Redefine(collections_res["PFParticles"],ROOT.SmearObjects.SmearedReconstructedParticle(5.93010, 130, 1, False),[collections["PFParticles"], "reco_mc_index", collections["GenParticles"]]) # 190.50382
