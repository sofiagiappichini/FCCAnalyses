...
output = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm240/ktN-tag/sub/' ##output directory of submission files, needs to be different to have unique submission files
outputDir_path = '/ceph/awiedl/FCCee/HiggsCP/ecm240/ktN-tag/stage2/' ##output directory of stage2 samples
localDir_path = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm240/ktN-tag/'
