...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = (df2
                .Define(collections_res["PFParticles"],ROOT.SmearObjects.SmearedReconstructedParticle(14.6875, 11, 1, False),[collections["PFParticles"], "reco_mc_index", collections["GenParticles"]])
                ...
                .Define("RecoElectrons",  "ReconstructedParticle::get(Electron0, {})".format(collections["PFParticles"]))
                ...
                .Define("RecoMuons",  "ReconstructedParticle::get(Muon0, {})".format(collections["PFParticles"]))
