...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = (df2
                .Define(collections_res["PFParticles"],ROOT.SmearObjects.SmearedReconstructedParticle(26.3, 11, 1, False),[collections["PFParticles"], "reco_mc_index", collections["GenParticles"]])
