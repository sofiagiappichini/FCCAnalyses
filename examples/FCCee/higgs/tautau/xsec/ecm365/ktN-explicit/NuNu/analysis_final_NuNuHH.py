...
inputDir = "/ceph/awiedl/FCCee/HiggsCP/ecm365/ktN-explicit/stage2_280125/NuNu/HH"

outputDir = "/ceph/sgiappic/HiggsCP/ecm365/ktN-explicit/final_280125/NuNu/HH"
...
cutList = {
    ...
    #"selReco_112Me_TauDPhi3_2DR_cos0.4_misscos0.98_missy1": "RecoEmiss_e>112 && abs(Tau_DPhi)<3 && Tau_DR>2 && Tau_cos<-0.4 && RecoEmiss_costheta<0.98 && abs(RecoEmiss_y)<1",
    #"selReco_112Me_TauDPhi3_2DR_cos0.4_misscos0.88_missy1": "RecoEmiss_e>112 && abs(Tau_DPhi)<3 && Tau_DR>2 && Tau_cos<-0.4 && RecoEmiss_costheta<0.88 && abs(RecoEmiss_y)<1",
