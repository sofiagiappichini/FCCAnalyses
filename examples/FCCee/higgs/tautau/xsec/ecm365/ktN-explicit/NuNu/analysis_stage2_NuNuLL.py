...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-explicit/stage2_241202_cut/NuNu/LL"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Filter("OnePair==1 && n_TagJet_R5_sel==0 && n_TauFromJet_R5==0") 
