...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-explicit/stage2_241202_cut/QQ/LL"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion
                ...
                .Filter("OnePair==1 && n_TauFromJet_kt2==0 && n_TagJet_kt2_sel==2")
                ...
                .Define("RecoZ1_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TagJet_kt2_sel_px.at(0), TagJet_kt2_sel_py.at(0), TagJet_kt2_sel_pz.at(0), TagJet_kt2_sel_e.at(0))")
                .Define("RecoZ2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TagJet_kt2_sel_px.at(1), TagJet_kt2_sel_py.at(1), TagJet_kt2_sel_pz.at(1), TagJet_kt2_sel_e.at(1))")
