...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-explicit/stage2_241202/QQ/LH"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion 
                ...
                .Filter("n_TauFromJet_kt3==1 && n_RecoLeptons_sel==1 && n_TagJet_kt3_sel==2")

                .Filter("(TauFromJet_kt3_charge.at(0) + RecoLepton_sel_charge.at(0))==0") 
                ...
                .Define("RecoZ1_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TagJet_kt3_sel_px.at(0), TagJet_kt3_sel_py.at(0), TagJet_kt3_sel_pz.at(0), TagJet_kt3_sel_e.at(0))")
                .Define("RecoZ2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TagJet_kt3_sel_px.at(1), TagJet_kt3_sel_py.at(1), TagJet_kt3_sel_pz.at(1), TagJet_kt3_sel_e.at(1))")
                ...
                .Define("RecoTau1_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TauFromJet_kt3_px.at(0), TauFromJet_kt3_py.at(0), TauFromJet_kt3_pz.at(0), TauFromJet_kt3_e.at(0))")
                .Define("RecoTau2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(RecoLepton_sel_px.at(0), RecoLepton_sel_py.at(0), RecoLepton_sel_pz.at(0), RecoLepton_sel_e.at(0))")
                ...
                .Define("TauP_p4","if (TauFromJet_kt3_charge.at(0)==1) return RecoTau1_p4; else return RecoTau2_p4;")
                ...
                .Define("TauM_p4",       "if (TauFromJet_kt3_charge.at(0)==1) return RecoTau2_p4; else return RecoTau1_p4;")
