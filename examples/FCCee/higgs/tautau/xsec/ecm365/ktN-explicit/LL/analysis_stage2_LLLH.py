...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-explicit/stage2_241202/LL/LH"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### defining filters for 3 lepton final state based on flavor combination: 3 same flavor, 1 pair, all plus one hadronic taus
                ...
                .Define("ThreeLeptons",    "(((n_RecoElectrons==3 and n_RecoMuons==0) or (n_RecoElectrons==0 and n_RecoMuons==3)) and (RecoLepton_charge.at(0) + RecoLepton_charge.at(1) + RecoLepton_charge.at(2) + TauFromJet_kt1_charge.at(0))==0)*1.0")
                .Define("OnePair",     "((n_RecoElectrons==2 and n_RecoMuons==1 and (RecoElectron_charge.at(0) + RecoElectron_charge.at(1))==0 and (RecoMuon_charge.at(0) + TauFromJet_kt1_charge.at(0))==0) or (n_RecoElectrons==1 and n_RecoMuons==2 and (RecoMuon_charge.at(0) + RecoMuon_charge.at(1))==0 and (RecoElectron_charge.at(0) + TauFromJet_kt1_charge.at(0))==0))*1.0")
        ...
        df2 = (df2
                ...
                .Define("RecoTau2_p4",      "FCCAnalyses::ZHfunctions::build_p4_single(TauFromJet_kt1_px.at(0), TauFromJet_kt1_py.at(0), TauFromJet_kt1_pz.at(0), TauFromJet_kt1_e.at(0))")
