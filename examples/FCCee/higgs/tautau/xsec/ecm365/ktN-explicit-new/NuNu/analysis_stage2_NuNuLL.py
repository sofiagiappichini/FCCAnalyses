...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-explicit/NuNu/LL/"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                # two leptons in the whole event that make the H boson
