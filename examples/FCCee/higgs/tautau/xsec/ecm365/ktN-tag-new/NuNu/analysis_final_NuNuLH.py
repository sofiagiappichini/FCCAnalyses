...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/final_250502/ktN-tag/NuNu/LH/"
...
cutList = {
    ...
    "selReco": "true",
    "selReco_180Me": "RecoEmiss_e>180 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_180Me_TauDPhi3": "RecoEmiss_e>180 && abs(Tau_DPhi)<3 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_180Me_TauDPhi3_1DR": "RecoEmiss_e>180 && abs(Tau_DPhi)<3 && Tau_DR>1 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_180Me_TauDPhi3_1DR_cos0.25": "RecoEmiss_e>180 && abs(Tau_DPhi)<3 && Tau_DR>1 && Tau_cos<0.25 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_180Me_TauDPhi3_1DR_cos0.25_misscos0.98": "RecoEmiss_e>180 && abs(Tau_DPhi)<3 && Tau_DR>1 && Tau_cos<0.25 && RecoEmiss_costheta<0.98 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
    "selReco_180Me_TauDPhi3_1DR_cos0.25_misscos0.98_missy1": "RecoEmiss_e>180 && abs(Tau_DPhi)<3 && Tau_DR>1 && Tau_cos<0.25 && RecoEmiss_costheta<0.98 && abs(RecoEmiss_y)<1 && n_TauLead_charged_constituents>0 && n_TauSub_charged_constituents>0",
