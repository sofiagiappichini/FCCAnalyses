...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-tag/QQ/LH/"
...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Filter("n_TauTag==1 && n_QuarkTag==2 && n_RecoLeptons_sel==1")
