...
DIRECTORIES = [
    ...
    #"/afs/cern.ch/user/s/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/stage3-new/ktN-explicit/",
    "/afs/cern.ch/user/s/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/stage3-new/ktN-tag/",
]
SUBDIR = [
    'LL',
    'LH',
