...
inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/efficiency"
...
intLumi = 3e6 #pb^-1 #to be checked again for 365 gev
...
cutList = {
    ...
    "sel_R5_excl":"n_events_R5excl==2",
    "sel_ktN_excl":"n_events_ktNexcl==2",

    "sel_R5_tag":"n_events_R5tag==2",
    "sel_ktN_tag":"n_events_ktNtag==2",
