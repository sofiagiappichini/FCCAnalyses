...
processList = {
    ...
    'wzp6_ee_bbH_Htautau_ecm365': {'chunks':10},

    'wzp6_ee_ccH_Htautau_ecm365': {'chunks':10},

    'wzp6_ee_ssH_Htautau_ecm365': {'chunks':10},

    'wzp6_ee_qqH_Htautau_ecm365': {'chunks':10},
}
...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/efficiency/"
...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("n_events_ktNtag",       "if (n_GenTau_had==n_TauTag_kt4_match && n_GenTau_had==1) return 1; else if (n_GenTau_had==n_TauTag_kt4_match && n_GenTau_had==2) return 2; else if (n_GenTau_had==n_TauTag_kt4_match && n_GenTau_had==0) return 0; else return -1;")
                .Define("n_events_ktNmasstag",       "if (n_GenTau_had==n_TauTag_kt4mass_match && n_GenTau_had==1) return 1; else if (n_GenTau_had==n_TauTag_kt4mass_match && n_GenTau_had==2) return 2;  else if (n_GenTau_had==n_TauTag_kt4mass_match && n_GenTau_had==0) return 0; else return -1;")
                .Define("n_events_ktNexcl",       "if (n_GenTau_had==n_TauFromJet_kt4_match && n_GenTau_had==1) return 1; else if (n_GenTau_had==n_TauFromJet_kt4_match && n_GenTau_had==2) return 2; else if (n_GenTau_had==n_TauFromJet_kt4_match && n_GenTau_had==0) return 0; else return -1;")
