...
output = '/work/sgiappic/HTCondor/stage3_ecm365/' ##output directory of submission files, needs to be different to have unique submission files
...
for tag in TAG:
    ...
    for cat in CAT:
        for sub in SUBDIR:
            ...
            outputDir = outputDir_path + tag + "/stage3_280125_test/" + cat + "/" + sub + "/"
