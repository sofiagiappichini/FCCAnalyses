...
output = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/submission/' ##output directory of submission files, needs to be different to have unique submission files
outputDir = '/ceph/awiedl/FCCee/HiggsCP/ecm365/stage1_280125/' ##output directory of stage2 samples
localDir = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/'
