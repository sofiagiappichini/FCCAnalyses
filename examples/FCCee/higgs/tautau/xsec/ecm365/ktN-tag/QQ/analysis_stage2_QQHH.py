...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-tag/stage2_241202_cut/QQ/HH"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion  
                ...
                .Define("TauTag_px",      "TagJet_kt4_px[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_py",      "TagJet_kt4_py[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_pz",      "TagJet_kt4_pz[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_pt",      "TagJet_kt4_pt[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_p",      "TagJet_kt4_p[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_e",      "TagJet_kt4_e[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_phi",      "TagJet_kt4_phi[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_eta",      "TagJet_kt4_eta[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_theta",      "TagJet_kt4_theta[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_charge",      "TagJet_kt4_charge[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_mass",      "TagJet_kt4_mass[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isG",      "TagJet_kt4_isG[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isU",      "TagJet_kt4_isU[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isD",      "TagJet_kt4_isD[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isS",      "TagJet_kt4_isS[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isC",      "TagJet_kt4_isC[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isB",      "TagJet_kt4_isB[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_isTAU",      "TagJet_kt4_isTAU[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("TauTag_flavor",      "TagJet_kt4_flavor[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_TauTag_constituents",        "n_TagJet_kt4_constituents[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_TauTag_charged_constituents",        "n_TagJet_kt4_charged_constituents[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_TauTag_neutral_constituents",        "n_TagJet_kt4_neutral_constituents[TagJet_kt4_isTAU>0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_TauTag",          "TauTag_px.size()")

                .Define("QuarkTag_px",      "TagJet_kt4_px[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_py",      "TagJet_kt4_py[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_pz",      "TagJet_kt4_pz[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_pt",      "TagJet_kt4_pt[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_p",      "TagJet_kt4_p[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_e",      "TagJet_kt4_e[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_phi",      "TagJet_kt4_phi[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_eta",      "TagJet_kt4_eta[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_theta",      "TagJet_kt4_theta[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_charge",      "TagJet_kt4_charge[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_mass",      "TagJet_kt4_mass[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isG",      "TagJet_kt4_isG[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isU",      "TagJet_kt4_isU[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isD",      "TagJet_kt4_isD[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isS",      "TagJet_kt4_isS[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isC",      "TagJet_kt4_isC[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isB",      "TagJet_kt4_isB[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_isTAU",      "TagJet_kt4_isTAU[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("QuarkTag_flavor",      "TagJet_kt4_flavor[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_QuarkTag_constituents",        "n_TagJet_kt4_constituents[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_QuarkTag_charged_constituents",        "n_TagJet_kt4_charged_constituents[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_QuarkTag_neutral_constituents",        "n_TagJet_kt4_neutral_constituents[TagJet_kt4_isTAU<=0.5 && TagJet_kt4_cleanup==1]")
                .Define("n_QuarkTag",     "QuarkTag_charge.size()")

                #############################

                .Filter("n_TauTag==2 && n_RecoLeptons_sel==0 && n_QuarkTag==2")
