...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ktN-tag/stage2_241202_cut/QQ/LH"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion 
                ...
                .Define("TauTag_px",      "TagJet_kt3_px[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_py",      "TagJet_kt3_py[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_pz",      "TagJet_kt3_pz[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_pt",      "TagJet_kt3_pt[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_p",      "TagJet_kt3_p[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_e",      "TagJet_kt3_e[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_phi",      "TagJet_kt3_phi[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_eta",      "TagJet_kt3_eta[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_theta",      "TagJet_kt3_theta[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_charge",      "TagJet_kt3_charge[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_mass",      "TagJet_kt3_mass[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isG",      "TagJet_kt3_isG[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isU",      "TagJet_kt3_isU[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isD",      "TagJet_kt3_isD[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isS",      "TagJet_kt3_isS[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isC",      "TagJet_kt3_isC[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isB",      "TagJet_kt3_isB[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_isTAU",      "TagJet_kt3_isTAU[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("TauTag_flavor",      "TagJet_kt3_flavor[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_TauTag_constituents",        "n_TagJet_kt3_constituents[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_TauTag_charged_constituents",        "n_TagJet_kt3_charged_constituents[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_TauTag_neutral_constituents",        "n_TagJet_kt3_neutral_constituents[TagJet_kt3_isTAU>0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_TauTag",          "TauTag_px.size()")

                .Define("QuarkTag_px",      "TagJet_kt3_px[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_py",      "TagJet_kt3_py[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_pz",      "TagJet_kt3_pz[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_pt",      "TagJet_kt3_pt[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_p",      "TagJet_kt3_p[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_e",      "TagJet_kt3_e[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_phi",      "TagJet_kt3_phi[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_eta",      "TagJet_kt3_eta[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_theta",      "TagJet_kt3_theta[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_charge",      "TagJet_kt3_charge[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_mass",      "TagJet_kt3_mass[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isG",      "TagJet_kt3_isG[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isU",      "TagJet_kt3_isU[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isD",      "TagJet_kt3_isD[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isS",      "TagJet_kt3_isS[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isC",      "TagJet_kt3_isC[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isB",      "TagJet_kt3_isB[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_isTAU",      "TagJet_kt3_isTAU[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("QuarkTag_flavor",      "TagJet_kt3_flavor[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_QuarkTag_constituents",        "n_TagJet_kt3_constituents[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_QuarkTag_charged_constituents",        "n_TagJet_kt3_charged_constituents[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_QuarkTag_neutral_constituents",        "n_TagJet_kt3_neutral_constituents[TagJet_kt3_isTAU<=0.5 && TagJet_kt3_cleanup==1]")
                .Define("n_QuarkTag",     "QuarkTag_charge.size()")

                ###############################

                .Filter("n_TauTag==1 && n_RecoLeptons_sel==1 && n_QuarkTag==2")
