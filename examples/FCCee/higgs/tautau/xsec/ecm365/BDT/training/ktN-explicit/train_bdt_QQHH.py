...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-explicit/stage2_280125_cut/QQ/HH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-explicit/output_QQHH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-explicit/' 

model = f"{out}/xgb_bdt_ktN-explicit_QQHH.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_ktN-explicit_QQHH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_ktN-explicit_QQHH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-explicit/BDT/QQHH_ROC_ktN-explicit.pdf")
