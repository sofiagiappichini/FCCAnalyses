...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-tag/stage2_280125_cut/NuNu/LH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-tag/output_NuNuLH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-tag/'

model = f"{out}/xgb_bdt_ktN-tag_NuNuLH.joblib"
...
#bdt.load_model(f"{out}/xgb_bdt_ktN-tag_NuNuLH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-tag/BDT/NuNuLH_ROC.pdf")
