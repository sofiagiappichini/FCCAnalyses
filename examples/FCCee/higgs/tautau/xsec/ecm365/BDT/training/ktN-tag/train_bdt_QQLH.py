...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-tag/stage2_280125_cut/QQ/LH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-tag/output_QQLH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-tag/' 

model = f"{out}/xgb_bdt_ktN-tag_QQLH.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_ktN-tag_QQLH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_ktN-tag_QQLH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-tag/BDT/QQLH_ROC_ktN-tag.pdf")
