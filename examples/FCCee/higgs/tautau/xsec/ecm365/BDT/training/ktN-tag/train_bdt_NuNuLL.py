...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-tag/stage2_280125_cut/NuNu/LL/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-tag/output_NuNuLL.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-tag/'

model = f"{out}/xgb_bdt_ktN-tag_NuNuLL.joblib"
...
#bdt.load_model(f"{out}/xgb_bdt_ktN-tag_NuNuLL_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-tag/BDT/NuNuLL_ROC.pdf")
