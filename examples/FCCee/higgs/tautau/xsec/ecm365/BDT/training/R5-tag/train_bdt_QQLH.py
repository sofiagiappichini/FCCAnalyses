...
path = "/ceph/sgiappic/HiggsCP/ecm365/R5-tag/stage2_280125_cut/QQ/LH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/R5-tag/output_QQLH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/R5-tag/' 

model = f"{out}/xgb_bdt_R5-tag_QQLH.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_R5-tag_QQLH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_R5-tag_QQLH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/R5-tag/BDT/QQLH_ROC_R5-tag.pdf")
