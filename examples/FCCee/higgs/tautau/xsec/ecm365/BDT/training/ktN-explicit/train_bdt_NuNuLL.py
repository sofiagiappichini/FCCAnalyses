...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-explicit/stage2_280125_cut/NuNu/LL/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-explicit/output_NuNuLL.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-explicit/'

model = f"{out}/xgb_bdt_ktN-explicit_NuNuLL.joblib"
...
#bdt.load_model(f"{out}/xgb_bdt_ktN-explicit_NuNuLL_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-explicit/BDT/NuNuLL_ROC.pdf")
