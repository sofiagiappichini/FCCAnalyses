...
path = "/ceph/sgiappic/HiggsCP/ecm365/R5-explicit/stage2_280125_cut/QQ/HH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/R5-explicit/output_QQHH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/R5-explicit/' 

model = f"{out}/xgb_bdt_R5-explicit_QQHH.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_R5-explicit_QQHH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_R5-explicit_QQHH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/R5-explicit/BDT/QQHH_ROC_R5-explicit.pdf")
