...
path = "/ceph/sgiappic/HiggsCP/ecm365/R5-tag/stage2_280125_cut/QQ/LL/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/R5-tag/output_QQLL.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/R5-tag/' 

model = f"{out}/xgb_bdt_R5-tag_QQLL.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_R5-tag_QQLL.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_R5-tag_QQLL_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/R5-tag/BDT/QQLL_ROC_R5-tag.pdf")
