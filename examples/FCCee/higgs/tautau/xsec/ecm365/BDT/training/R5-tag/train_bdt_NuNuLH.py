...
path = "/ceph/sgiappic/HiggsCP/ecm365/R5-tag/stage2_280125_cut/NuNu/LH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/R5-tag/output_NuNuLH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/R5-tag/'

model = f"{out}/xgb_bdt_R5-tag_NuNuLH.joblib"
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_R5-tag_NuNuLH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_R5-tag_NuNuLH_model.json")

#bdt = xgb.XGBClassifier()
#bdt.load_model(f"{out}/xgb_bdt_R5-tag_NuNuLH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/R5-tag/BDT/NuNuLH_ROC.pdf")
