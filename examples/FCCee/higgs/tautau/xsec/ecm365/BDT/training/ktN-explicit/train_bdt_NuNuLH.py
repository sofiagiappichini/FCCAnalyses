...
path = "/ceph/sgiappic/HiggsCP/ecm365/ktN-explicit/stage2_280125_cut/NuNu/LH/"

output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/outputs/ktN-explicit/output_NuNuLH.txt"

out = '/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm365/BDT/models/ktN-explicit/'

model = f"{out}/xgb_bdt_ktN-explicit_NuNuLH.joblib"
...
#bdt.load_model(f"{out}/xgb_bdt_ktN-explicit_NuNuLH_model.json")
...
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/ecm365/ktN-explicit/BDT/NuNuLH_ROC.pdf")
