...
inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-explicit/NuNu/LL/"

#Optional: output directory, default is local running directory
outputDir   = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/BDT_250502/ktN-explicit/stage3/NuNu/LL/" 
...
ROOT.gInterpreter.ProcessLine('''TMVA::Experimental::RBDT<> bdt("Htautau", "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/BDT_250502/ktN-explicit/xgb_bdt_ktN-explicit_NuNuLL.root");
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("fRecoEmiss_pz",       "static_cast<float>(RecoEmiss_pz)")
                .Define("fRecoEmiss_pt",       "static_cast<float>(RecoEmiss_pt)")
                .Define("fRecoEmiss_p",       "static_cast<float>(RecoEmiss_p)")
                .Define("fRecoEmiss_e",       "static_cast<float>(RecoEmiss_e)")
