...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-tag/LL/HH/"
...
joblib.dump(df_train, out + 'train_data_ktN-tag_LLHH.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-tag_LLHH.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-tag_LLHH.joblib")
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_ktN-tag_LLHH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_ktN-tag_LLHH_model.json")
