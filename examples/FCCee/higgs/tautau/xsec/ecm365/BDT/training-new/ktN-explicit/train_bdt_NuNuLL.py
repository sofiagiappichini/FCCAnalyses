...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-explicit/NuNu/LL/"
...
joblib.dump(df_train, out + 'train_data_ktN-explicit_NuNuLL.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-explicit_NuNuLL.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-explicit_NuNuLL.joblib")
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_ktN-explicit_NuNuLL.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_ktN-explicit_NuNuLL_model.json")
