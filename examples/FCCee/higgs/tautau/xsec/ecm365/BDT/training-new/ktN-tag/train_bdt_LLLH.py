...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-tag/LL/LH/"
...
joblib.dump(df_train, out + 'train_data_ktN-tag_LLLH.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-tag_LLLH.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-tag_LLLH.joblib")
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_ktN-tag_LLLH.root", num_inputs=len(vars_list))

bdt.save_model(f"{out}/xgb_bdt_ktN-tag_LLLH_model.json")
