...
path = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm365/stage1_250502/ktN-tag/QQ/HH/"
...
joblib.dump(df_train, out + 'train_data_ktN-tag_QQHH.pkl')
joblib.dump(df_test, out+ 'test_data_ktN-tag_QQHH.pkl')
...
joblib.dump(bdt, f"{out}/xgb_bdt_ktN-tag_QQHH.joblib")
