...
def process_content_of_row_simple(content_of_row):
...
def do_combine_simple(outdir, file):
...
def do_combine_alt_simple(outdir, file):
    ...
    for cat in CAT:
        for sub in SUBDIR:
            ...
            if "NuNu" in cat:
                ...
                content_of_row = do_combine_simple(dir, file_read)

                if "+19" or "+19.001" or "-11" in content_of_row:
                    print("REPORCESSING")
                    content_of_row = do_combine_alt_simple(dir, file_read)
                    
                processed= process_content_of_row_simple(content_of_row)
        ...
        if "NuNu" in cat:
            ...
            content_of_row = do_combine_simple(cat_dir, input_file_dir)

            if "+19" or "-11" in content_of_row:
                print("REPORCESSING")
                content_of_row = do_combine_alt_simple(cat_dir, input_file_dir)
