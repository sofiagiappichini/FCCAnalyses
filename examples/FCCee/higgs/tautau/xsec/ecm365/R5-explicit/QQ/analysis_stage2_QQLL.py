...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/R5-explicit/stage2_241202_cut/QQ/LL"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion
                ...
                .Filter("OnePair==1 && n_TauFromJet_R5==0 && n_TagJet_R5_sel==2")
                ...
                .Define("Total_p4",     "FCCAnalyses::ZHfunctions::build_p4_single(0.,0.,0.,365.)")
