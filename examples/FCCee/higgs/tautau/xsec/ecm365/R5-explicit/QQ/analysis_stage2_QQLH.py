...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/R5-explicit/stage2_241202_cut/QQ/LH"
    ...
    def analysers(df):
        df2 = (df
            ...
            ### when working with tau jets it does not matter since the tau jets don't have any lepton in them so there is no confusion 
                ...
                .Filter("n_TauFromJet_R5==1 && n_RecoLeptons_sel==1 && n_TagJet_R5_sel==2")
