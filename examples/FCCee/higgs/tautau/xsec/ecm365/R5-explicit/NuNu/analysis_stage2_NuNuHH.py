...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/R5-explicit/stage2_241202_cut/NuNu/HH"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Filter("n_TauFromJet_R5==2 && n_TagJet_R5_sel==0 && n_RecoLeptons==0 && (TauFromJet_R5_charge.at(0) + TauFromJet_R5_charge.at(1))==0") 
