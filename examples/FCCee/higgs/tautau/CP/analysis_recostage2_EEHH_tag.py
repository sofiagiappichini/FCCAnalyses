...
outputDir = "/ceph/sgiappic/HiggsCP/CPReco_2Pi2Nu/stage2/"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("TauP_d_p4",        "if (ChargedPar_charge.at(0)==1) return Impact_p4.at(0); else return Impact_p4.at(1);")
                .Define("TauM_d_p4",        "if (ChargedPar_charge.at(0)==1) return Impact_p4.at(1); else return Impact_p4.at(0);")
                .Define("TauP_p_p4",        "if (ChargedPar_charge.at(0)==1) return ChargedPar_p4.at(0); else return ChargedPar_p4.at(1);")
                .Define("TauM_p_p4",        "if (ChargedPar_charge.at(0)==1) return ChargedPar_p4.at(1); else return ChargedPar_p4.at(0);")
                .Define("TauP_k_p4",        "if (ChargedPar_charge.at(0)==1) return NeutralSyst_p4.at(0); else return NeutralSyst_p4.at(1);")
                .Define("TauM_k_p4",        "if (ChargedPar_charge.at(0)==1) return NeutralSyst_p4.at(1); else return NeutralSyst_p4.at(0);")
                .Define("TauP_h_p4",     "if (ChargedPar_charge.at(0)==1) return ChargedPar_p4.at(0) + NeutralSyst_p4.at(0); else return ChargedPar_p4.at(1) + NeutralSyst_p4.at(1);") #in general p+h where h is the neutral hadron system
                .Define("TauM_h_p4",     "if (ChargedPar_charge.at(0)==1) return ChargedPar_p4.at(1) + NeutralSyst_p4.at(1); else return ChargedPar_p4.at(0) + NeutralSyst_p4.at(0);")
                ...
                .Define("True_TauP_p4",       "if (ChargedPar_charge.at(0)==1) return True_Tau_p4.at(0); else return True_Tau_p4.at(1);")
                .Define("True_TauP_idx",       "if (ChargedPar_charge.at(0)==1) return 0; else return 1;")
                ...
                .Define("True_TauM_p4",       "if (ChargedPar_charge.at(0)==1) return True_Tau_p4.at(1); else return True_Tau_p4.at(0);")
                .Define("True_TauM_idx",       "if (ChargedPar_charge.at(0)==1) return 1; else return 0;")
                ...
                .Define("GenRecoTauP_charge",        "if (n_GenTau_had==2 and HadGenTau_charge.at(0)==1) return (ChargedPar_charge.at(True_TauP_idx) - HadGenTau_charge.at(0)); else if (n_GenTau_had==2 and HadGenTau_charge.at(0)==(-1)) return (ChargedPar_charge.at(True_TauP_idx) - HadGenTau_charge.at(1)); else return float (-99.); ")
                ...
                .Define("GenRecoTauM_charge",        "if (n_GenTau_had==2 and HadGenTau_charge.at(0)==1) return (ChargedPar_charge.at(True_TauM_idx) - HadGenTau_charge.at(1)); else if (n_GenTau_had==2 and HadGenTau_charge.at(0)==(-1)) return (ChargedPar_charge.at(True_TauM_idx) - HadGenTau_charge.at(0)); else return float (-99.); ")
                ...
                .Define("ZMF_p4",       "ChargedPar_p4.at(0) + ChargedPar_p4.at(1)")
                .Define("ZMF_RecoPiP_p4",    "if (ChargedPar_charge.at(0)==1) return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedPar_p4.at(0)); else return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedPar_p4.at(1));")
                .Define("ZMF_ImpactP_p4",    "if (ChargedPar_charge.at(0)==1) return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, Impact_p4.at(0)); else return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, Impact_p4.at(1));")

                .Define("ZMF_RecoPiM_p4",    "if (ChargedPar_charge.at(0)==1) return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedPar_p4.at(1)); else return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedPar_p4.at(0));")
                .Define("ZMF_ImpactM_p4",    "if (ChargedPar_charge.at(0)==1) return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, Impact_p4.at(1)); else return FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, Impact_p4.at(0));")
