...
histoList = {
    ...
    "FSGenZLead_eta":              {"name":"FSGenZLead_eta",                "title":"Gen leading Z daughter #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZLead_phi":              {"name":"FSGenZLead_phi",                "title":"Gen leading Z daughter #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSGenZSub_eta":               {"name":"FSGenZSub_eta",                "title":"Gen subleading Z daughter #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZSub_phi":               {"name":"FSGenZSub_phi",                "title":"Gen subleading Z daughter #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSGenZP_eta":              {"name":"FSGenZP_eta",                "title":"Gen positive Z daughter #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZP_phi":              {"name":"FSGenZP_phi",                "title":"Gen positive Z daughter #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSGenZM_eta":               {"name":"FSGenZM_eta",                "title":"Gen negative Z daughter #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZM_phi":               {"name":"FSGenZM_phi",                "title":"Gen negative Z daughter #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSRGenTauLead_eta":              {"name":"FSRGenTauLead_eta",                "title":"#tau_{leading} #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSRGenTauLead_phi":              {"name":"FSRGenTauLead_phi",                "title":"#tau_{leading} #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSRGenTauSub_eta":               {"name":"FSRGenTauSub_eta",                "title":"#tau_{subleading} #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSRGenTauSub_phi":               {"name":"FSRGenTauSub_phi",                "title":"#tau_{subleading} #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSRGenTauP_eta":              {"name":"FSRGenTauP_eta",                "title":"#tau^{+} #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSRGenTauP_phi":              {"name":"FSRGenTauP_phi",                "title":"#tau^{+} #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSRGenTauM_eta":               {"name":"FSRGenTauM_eta",                "title":"#tau^{-} #eta",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSRGenTauM_phi":               {"name":"FSRGenTauM_phi",                "title":"#tau^{-} #phi",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSRGenTau_DPhi":         {"name":"FSRGenTau_DPhi",           "title":"#Delta#phi(#tau#tau)",                "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSGenZDaughter_DPhi":         {"name":"FSGenZDaughter_DPhi",           "title":"#Delta#phi(ll)",                "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "FSGenZDaughter_DEta":                   {"name":"FSGenZDaughter_DEta",           "title":"Gen Z daughters #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},

    #### CP variables

    "FSRGenTau_DEta_y":                             {"name":"FSRGenTau_DEta_y",           "title":"Gen di-#tau #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSRGenTau_DPhi_y":                           {"name":"FSRGenTau_DPhi_y",           "title":"#Delta#phi(#tau#tau)",                "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZDaughter_DEta_y":                 {"name":"FSGenZDaughter_DEta_y",           "title":"Gen Z daughters #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "FSGenZDaughter_DPhi_y":                 {"name":"FSGenZDaughter_DPhi_y",           "title":"Gen Z daughters #Delta#phi",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenTauLead_eta":                {"name":"HRF_GenTauLead_eta",                "title":"Gen #tau_{leading} #eta in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTauLead_phi":                {"name":"HRF_GenTauLead_phi",                "title":"Gen #tau_{leading} #phi in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenTauSub_eta":                {"name":"HRF_GenTauSub_eta",                "title":"Gen #tau_{subleading} #eta in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTauSub_phi":                {"name":"HRF_GenTauSub_phi",                "title":"Gen #tau_{subleading} #phi in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenTauP_eta":                {"name":"HRF_GenTauP_eta",                "title":"Gen #tau^{+} #eta in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTauP_phi":                {"name":"HRF_GenTauP_phi",                "title":"Gen #tau^{+} #phi in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenTauM_eta":                {"name":"HRF_GenTauM_eta",                "title":"Gen #tau^{-} #eta in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTauM_phi":                {"name":"HRF_GenTauM_phi",                "title":"Gen #tau^{-} #phi in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenTau_DPhi":           {"name":"HRF_GenTau_DPhi",           "title":"Gen di-#tau #Delta#phi in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTau_DEta_y":                   {"name":"HRF_GenTau_DEta_y",           "title":"Gen di-#tau #Delta#eta in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenTau_DPhi_y":           {"name":"HRF_GenTau_DPhi_y",           "title":"Gen di-#tau #Delta#phi in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_GenZLead_eta":                {"name":"ZRF_GenZLead_eta",                "title":"Gen leading Z daughter #eta in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZLead_phi":                {"name":"ZRF_GenZLead_phi",                "title":"Gen leading Z daughter #phi in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_GenZSub_eta":                {"name":"ZRF_GenZSub_eta",                "title":"Gen subleading Z daughter #eta in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZSub_phi":                {"name":"ZRF_GenZSub_phi",                "title":"Gen subleading Z daughter #phi in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_GenZP_eta":                {"name":"ZRF_GenZP_eta",                "title":"Gen positive Z daughter #eta in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZP_phi":                {"name":"ZRF_GenZP_phi",                "title":"Gen positive Z daughter #phi in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_GenZM_eta":                {"name":"ZRF_GenZM_eta",                "title":"Gen negative Z daughter #eta in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZM_phi":                {"name":"ZRF_GenZM_phi",                "title":"Gen negative Z daughter #phi in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_GenZDaughter_DEta":                   {"name":"ZRF_GenZDaughter_DEta",           "title":"Gen Z daughters #Delta#eta in Z rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZDaughter_DPhi":           {"name":"ZRF_GenZDaughter_DPhi",           "title":"Gen Z daughters #Delta#phi in Z rest frame",          "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZDaughter_DEta_y":                   {"name":"ZRF_GenZDaughter_DEta_y",           "title":"Gen Z daughters #Delta#eta in Z rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_GenZDaughter_DPhi_y":           {"name":"ZRF_GenZDaughter_DPhi_y",           "title":"Gen Z daughters #Delta#phi in Z rest frame",          "bin":32, "xmin":-3.2,"xmax":3.2},
