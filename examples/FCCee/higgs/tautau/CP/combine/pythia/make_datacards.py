...
DIRECTORY = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/CP/final_2ab-1/ktN-explicit/"
SUBDIR = [
    #'LL',
    #'LH',
    'HH',
...
CUTS = {
    'LLHH':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100_oneprong", #oneprong
    'LLLH':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100",
    'LLLL':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100_20EM_HE110",
    'QQHH':"selReco_100Coll150_115Rec160_2DR_0.98cos0.6_misscos0.98_80Z100_jets_10EM_40Zp55_oneprong",
    #'QQHH':"selReco_0.995BDT",
    'QQLH':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100_jets_10EM_40Zp55",
    'QQLL':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100_jets_10EM_40Zp55_HE95",
...
signals_dict = {
    "p8_ee_LLH_Htautau_CPeven":"ZH_LL_sm",
    "p8_ee_LLH_Htautau_CPmix":"ZH_LL_mm",
    "p8_ee_LLH_Htautau_CPodd":"ZH_LL_ps",

    "p8_ee_QQH_Htautau_CPeven":"ZH_QQ_sm",
    "p8_ee_QQH_Htautau_CPmix":"ZH_QQ_mm",
    "p8_ee_QQH_Htautau_CPodd":"ZH_QQ_ps",
}
    ...
    for cat in CAT:
        for sub in SUBDIR:
            ...
            if rebinned:
                ...
                for p in procs:
                    if p in signals:
                        sig_procs.append(signals_dict[p])
                    else:
                        bkg_procs.append(p)
            ...
            procs_str = " ".join(f"{signals_dict[proc]:{' '}{'<'}{lspace}}" for proc in sig_procs)
            procs_str += " ".join(f"{proc:{' '}{'<'}{lspace}}" for proc in bkg_procs)
            ...
            if rebinned:
                ...
                for proc in procs:
                    if proc in signals:
                        dc += f"shapes {signals_dict[proc]} * {directory}{proc}_{cut}_histo.root $CHANNEL\n"
                    else:
