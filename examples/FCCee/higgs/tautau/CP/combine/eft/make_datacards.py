...
outputDir = "/afs/cern.ch/user/s/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/CP/combine/eft/251203/"
...
CUTS = {
    'LL':"selReco_100Coll150_115Rec160_2DR_cos0.6_misscos0.98_80Z100_oneprong",
    'QQ':"selReco_100Coll150_115Rec160_2DR_0.98cos0.6_misscos0.98_80Z100_jets_10EM_40Zp55_oneprong",
...
backgrounds_all = [
    ...
    "quad_cehim",
    "quad_cehre",
    "sm_lin_quad_mixed_cehre_cehim",
    "sm_lin_quad_mixed_cehim_chb",
    "sm_lin_quad_mixed_cehim_chbtil",
    "sm_lin_quad_mixed_cehim_chwb",
    "sm_lin_quad_mixed_cehim_chwbtil",
    "sm_lin_quad_mixed_cehim_chw",
    "sm_lin_quad_mixed_cehim_chwtil",
    "sm_lin_quad_mixed_cehre_chb",
    "sm_lin_quad_mixed_cehre_chbtil",
    "sm_lin_quad_mixed_cehre_chwb",
    "sm_lin_quad_mixed_cehre_chwbtil",
    "sm_lin_quad_mixed_cehre_chw",
    "sm_lin_quad_mixed_cehre_chwtil",
    "sm_lin_quad_mixed_chb_chbtil",
    "sm_lin_quad_mixed_chb_chwb",
    "sm_lin_quad_mixed_chb_chwbtil",
    "sm_lin_quad_mixed_chb_chw",
    "sm_lin_quad_mixed_chb_chwtil",
    "sm_lin_quad_chb",
    "quad_chb",
    "sm_lin_quad_mixed_chbtil_chwb",
    "sm_lin_quad_mixed_chbtil_chwbtil",
    "sm_lin_quad_mixed_chbtil_chw",
    "sm_lin_quad_mixed_chbtil_chwtil",
    "sm_lin_quad_chbtil",
    "quad_chbtil",
    "sm_lin_quad_mixed_chwb_chwbtil",
    "sm_lin_quad_chwb",
    "sm_lin_quad_chwbtil",
    "quad_chwb",
    "quad_chwbtil",
    "sm_lin_quad_mixed_chw_chwb",
    "sm_lin_quad_mixed_chw_chwbtil",
    "sm_lin_quad_mixed_chw_chwtil",
    "sm_lin_quad_chw",
    "quad_chw",
    "sm_lin_quad_mixed_chwtil_chwb",
    "sm_lin_quad_mixed_chwtil_chwbtil",
    "sm_lin_quad_chwtil",
    "quad_chwtil",
]
    ...
    for cat in CAT:
        for sub in SUBDIR:
            ...
            if rebinned:
                ...
                dc += f"shapes data_obs * {directory}{sig_procs[0]}_{cut}_histo.root $CHANNEL\n"
