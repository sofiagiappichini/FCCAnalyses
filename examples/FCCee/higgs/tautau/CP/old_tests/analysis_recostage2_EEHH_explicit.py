...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Redefine("RecoIP_p4",     "TLorentzVector(RecoDecayVertexZ.position.x, RecoDecayVertexZ.position.y, RecoDecayVertexZ.position.z, 0.)")
    ...
    def output():
        ...
        branchList += [
            ...
            "RecoEmiss_p4",
            "ChargedTauImpactP_p4",  
            "ChargedTauImpactM_p4",
            ##
