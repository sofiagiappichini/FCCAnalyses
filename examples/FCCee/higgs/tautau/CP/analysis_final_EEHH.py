...
histoList = {
    ...
    "GenDiTau_DEta":              {"name":"GenDiTau_DEta",              "title":"Gen di-#tau #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "GenDiTau_DPhi":              {"name":"GenDiTau_DPhi",              "title":"Gen di-#tau #Delta#phi",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "GenDiTau_cos":               {"name":"GenDiTau_cos",               "title":"Gen di-#tau cos#theta",                   "bin":100, "xmin":-1.,"xmax":1.},
    "GenDiTau_DR":                {"name":"GenDiTau_DR",                "title":"Gen di-#tau #Delta R",                    "bin":70, "xmin":0,"xmax":7.},

    "GenDiTau_DEta":           {"name":"GenDiTau_DEta",           "title":"Gen di-#tau #Delta#eta in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "GenDiTau_DPhi":           {"name":"GenDiTau_DPhi",           "title":"Gen di-#tau #Delta#phi in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_GenDiTau_DEta":           {"name":"HRF_GenDiTau_DEta",           "title":"Gen di-#tau #Delta#eta in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_GenDiTau_DPhi":           {"name":"HRF_GenDiTau_DPhi",           "title":"Gen di-#tau #Delta#phi in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoDiTau_DEta":               {"name":"RecoDiTau_DEta",           "title":"Reco di-#tau #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "RecoDiTau_DPhi":               {"name":"RecoDiTau_DPhi",           "title":"Reco di-#tau #Delta#phi",                  "bin":32, "xmin":-3.2,"xmax":3.2},

    "RecoDiElectron_DEta":           {"name":"RecoDiElectron_DEta",           "title":"Reco di-electron #Delta#eta",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "RecoDiElectron_DPhi":           {"name":"RecoDiElectron_DPhi",           "title":"Reco di-electron #Delta#phi",                  "bin":32, "xmin":-3.2,"xmax":3.2},

    "HRF_RecoTau_px":                 {"name":"HRF_RecoTau_px",                 "title":"Reco #tau p_{x} [GeV] in H rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "HRF_RecoTau_py":                 {"name":"HRF_RecoTau_py",                 "title":"Reco #tau p_{y} [GeV] in H rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "HRF_RecoTau_pz":                 {"name":"HRF_RecoTau_pz",                 "title":"Reco #tau p_{z} [GeV] in H rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "HRF_RecoTau_p":                  {"name":"HRF_RecoTau_p",                  "title":"Reco #tau p [GeV] in H rest frame",                "bin":75, "xmin":0 ,"xmax":150},
    "HRF_RecoTau_pt":                 {"name":"HRF_RecoTau_pt",                 "title":"Reco #tau p_{T} [GeV] in H rest frame",            "bin":75, "xmin":0 ,"xmax":150},
    "HRF_RecoTau_e":                  {"name":"HRF_RecoTau_e",                  "title":"Reco #tau energy [GeV] in H rest frame",           "bin":75, "xmin":0 ,"xmax":150},
    "HRF_RecoTau_eta":                {"name":"HRF_RecoTau_eta",                "title":"Reco #tau #eta in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_RecoTau_phi":                {"name":"HRF_RecoTau_phi",                "title":"Reco #tau #phi in H rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_RecoTau_theta":              {"name":"HRF_RecoTau_theta",              "title":"Reco #tau #theta in H rest frame",                 "bin":16, "xmin":0,"xmax":3.2},
    "HRF_RecoTau_y":                  {"name":"HRF_RecoTau_y",                  "title":"Reco #tau rapidity in H rest frame",               "bin":40, "xmin":-4., "xmax":4.},
        
    "HRF_RecoDiTau_DEta":           {"name":"HRF_RecoDiTau_DEta",           "title":"Reco di-#tau #Delta#eta in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "HRF_RecoDiTau_DPhi":           {"name":"HRF_RecoDiTau_DPhi",           "title":"Reco di-#tau #Delta#phi in H rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},

    "ZRF_RecoElectron_px":                 {"name":"ZRF_RecoElectron_px",                 "title":"Reco electron p_{x} [GeV] in Z rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "ZRF_RecoElectron_py":                 {"name":"ZRF_RecoElectron_py",                 "title":"Reco electron p_{y} [GeV] in Z rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "ZRF_RecoElectron_pz":                 {"name":"ZRF_RecoElectron_pz",                 "title":"Reco electron p_{z} [GeV] in Z rest frame",            "bin":50,"xmin":-100 ,"xmax":100},
    "ZRF_RecoElectron_p":                  {"name":"ZRF_RecoElectron_p",                  "title":"Reco electron p [GeV] in Z rest frame",                "bin":75, "xmin":0 ,"xmax":150},
    "ZRF_RecoElectron_pt":                 {"name":"ZRF_RecoElectron_pt",                 "title":"Reco electron p_{T} [GeV] in Z rest frame",            "bin":75, "xmin":0 ,"xmax":150},
    "ZRF_RecoElectron_e":                  {"name":"ZRF_RecoElectron_e",                  "title":"Reco electron energy [GeV] in Z rest frame",           "bin":75, "xmin":0 ,"xmax":150},
    "ZRF_RecoElectron_eta":                {"name":"ZRF_RecoElectron_eta",                "title":"Reco electron #eta in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoElectron_phi":                {"name":"ZRF_RecoElectron_phi",                "title":"Reco electron #phi in Z rest frame",                   "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoElectron_theta":              {"name":"ZRF_RecoElectron_theta",              "title":"Reco electron #theta in Z rest frame",                 "bin":16, "xmin":0,"xmax":3.2},
    "ZRF_RecoElectron_y":                  {"name":"ZRF_RecoElectron_y",                  "title":"Reco electron rapidity in Z rest frame",               "bin":40, "xmin":-4., "xmax":4.},
        
    "ZRF_RecoDiElectron_DEta":           {"name":"ZRF_RecoDiElectron_DEta",           "title":"Reco di-electron #Delta#eta in Z rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoDiElectron_DPhi":           {"name":"ZRF_RecoDiElectron_DPhi",           "title":"Reco di-electron #Delta#phi in Z rest frame",                  "bin":32, "xmin":-3.2,"xmax":3.2},
