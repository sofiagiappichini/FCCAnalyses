...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                #boosted_p4 function will boost a vector of 4-vectors(_tlv, last component is the time/energy), to go to the rest frame you need to use the inverse vector 
                .Define("GenZ_p4",     "FCCAnalyses::ZHfunctions::build_p4(GenZ_px, GenZ_py, GenZ_pz, GenZ_e)")
                ...
                .Define("ZRF_GenElectron_p4",    "return myUtils::boosted_p4(- GenZ_p4.at(0), FSGenElectron_p4);")
                ...
                .Define("GenThetastar",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{GenHiggs_p4.at(0)}, HRF_GenTau_p4[HRF_GenTau_charge==-1])/(GenHiggs_p.at(0)*HRF_GenTau_p[HRF_GenTau_charge==-1]))")
                #angle between Z vector in lab frame and Muon in Z rest frame
                .Define("GenTheta1",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{GenZ_p4.at(0)}, ZRF_GenElectron_p4[ZRF_GenElectron_charge==-1])/(GenZ_p.at(0)*ZRF_GenElectron_p[ZRF_GenElectron_charge==-1]))")
                #angle between decay planes of H and Z
                .Define("GenPhi1",      "acos(FCCAnalyses::ZHfunctions::get_scalar(HRF_GenTau_p4[HRF_GenTau_charge==-1], ZRF_GenElectron_p4[ZRF_GenElectron_charge==-1])/(HRF_GenTau_p[HRF_GenTau_charge==-1]*ZRF_GenElectron_p[ZRF_GenElectron_charge==-1]))")
                ...
                .Define("GenPhi",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{Beam_vec}, ZRF_GenElectron_p4[ZRF_GenElectron_charge==-1])/(Beam_p*ZRF_GenElectron_p[ZRF_GenElectron_charge==-1]))")
                .Define("GenTheta2",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{Beam_vec}, ROOT::VecOps::RVec<TLorentzVector>{GenZ_p4.at(0)})/(Beam_p*GenZ_p.at(0)))")
                ...
                .Filter("TauFromJet_R5_type.at(0)==0 and TauFromJet_R5_type.at(1)==0 and (TauFromJet_R5_charge.at(0) + TauFromJet_R5_charge.at(1))==0")
                ...
                #may be interesting to simnply keep the cosine of thetas (John Hopkins)
                #angle between H vector in lab frame and tau in H rest frame
                .Define("RecoThetastar",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{RecoH_p4}, HRF_RecoTau_p4[HRF_RecoTau_charge==-1])/(RecoH_p*HRF_RecoTau_p[HRF_RecoTau_charge==-1]))")
                #angle between Z vector in lab frame and Muon in Z rest frame
                ...
                #angle between decay planes of H and Z
                .Define("RecoPhi1",      "acos(FCCAnalyses::ZHfunctions::get_scalar(HRF_RecoTau_p4[HRF_RecoTau_charge==-1], ZRF_RecoElectron_p4[ZRF_RecoElectron_charge==-1])/(HRF_RecoTau_p[HRF_RecoTau_charge==-1]*ZRF_RecoElectron_p[ZRF_RecoElectron_charge==-1]))")
                #angle between beam line and Z decay plane
                .Define("RecoPhi",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{Beam_vec}, ZRF_RecoElectron_p4[ZRF_RecoElectron_charge==-1])/(Beam_p*ZRF_RecoElectron_p[ZRF_RecoElectron_charge==-1]))")
                .Define("RecoTheta2",      "acos(FCCAnalyses::ZHfunctions::get_scalar(ROOT::VecOps::RVec<TLorentzVector>{Beam_vec}, ROOT::VecOps::RVec<TLorentzVector>{RecoZ_p4})/(Beam_p*RecoZ_p))")
    ...
    def output():
        ...
        branchList = [
                ...
                #"ZFSGenElectron_y",
                #"ZFSGenElectron_eta",
                #"ZFSGenElectron_theta",
                #"ZFSGenElectron_phi",
                #"ZFSGenElectron_charge",
                #"ZFSGenElectron_mass",
                #"ZFSGenElectron_parentPDG",
                #"ZFSGenElectron_vertex_x",
                #"ZFSGenElectron_vertex_y",
                #"ZFSGenElectron_vertex_z",
        ...
        branchList += [
                ...
                #### madgraph is not saving the gen Z with the sintax used so it doesn't always work
                ...
                #"ZRF_GenElectron_eta", 
                #"ZRF_GenElectron_phi",  
                #"ZRF_GenElectron_theta",    
                #"ZRF_GenElectron_y", 

                #"ZRF_GenDiElectron_DEta", 
                #"ZRF_GenDiElectron_DPhi", 
