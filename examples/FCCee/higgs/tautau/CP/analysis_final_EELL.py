...
inputDir = "/ceph/sgiappic/HiggsCP/CP/stage2_tag_EELL"

#Optional: output directory, default is local running directory
outputDir = "/ceph/sgiappic/HiggsCP/CP/final_tag_EELL"
...
procDictAdd = {
    ...
    'noISR_e+e-_noCuts_cehim_m1':{"numberOfEvents": 100000, "sumOfWeights": 100000, "crossSection": 0.00051749743218, "kfactor": 1.0, "matchingEfficiency": 1.0},
    'noISR_e+e-_noCuts_cehim_p1':{"numberOfEvents": 100000, "sumOfWeights": 100000, "crossSection": 0.00051749743218, "kfactor": 1.0, "matchingEfficiency": 1.0},
...
histoList = {
    ...
    "RecoElectron_eta":                 {"name":"RecoElectron_eta",                 "title":"Reco electron #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoElectron_theta":               {"name":"RecoElectron_theta",               "title":"Reco electron #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoElectron_sel_eta":                 {"name":"RecoElectron_sel_eta",                 "title":"Reco electron isolated #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoElectron_sel_theta":               {"name":"RecoElectron_sel_theta",               "title":"Reco electron isolated #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "RecoElectron_sel_phi":                 {"name":"RecoElectron_sel_phi",                 "title":"Reco electron isolated #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoMuon_eta":                 {"name":"RecoMuon_eta",                 "title":"Reco muon #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoMuon_theta":               {"name":"RecoMuon_theta",               "title":"Reco muon #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoMuon_sel_eta":                 {"name":"RecoMuon_sel_eta",                 "title":"Reco muon isolated #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoMuon_sel_theta":               {"name":"RecoMuon_sel_theta",               "title":"Reco muon isolated #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "RecoMuon_sel_phi":                 {"name":"RecoMuon_sel_phi",                 "title":"Reco muon isolated #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoLepton_eta":               {"name":"RecoLepton_eta",                 "title":"Reco lepton #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoLepton_theta":             {"name":"RecoLepton_theta",               "title":"Reco lepton #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoLepton_sel_eta":               {"name":"RecoLepton_sel_eta",                 "title":"Reco lepton isolated #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoLepton_sel_theta":             {"name":"RecoLepton_sel_theta",               "title":"Reco lepton isolated #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "RecoLepton_sel_phi":               {"name":"RecoLepton_sel_phi",                 "title":"Reco lepton isolated #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoPhoton_eta":           {"name":"RecoPhoton_eta",                 "title":"Reco photon #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoPhoton_theta":         {"name":"RecoPhoton_theta",               "title":"Reco photon #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "NeutralHadrons_eta":           {"name":"NeutralHadrons_eta",                 "title":"Neutral hadron #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "NeutralHadrons_theta":         {"name":"NeutralHadrons_theta",               "title":"Neutral hadron #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "NeutralHadrons_phi":           {"name":"NeutralHadrons_phi",                 "title":"Neutral hadron #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoEmiss_eta":            {"name":"RecoEmiss_eta",                 "title":"Reco missing energy #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoEmiss_phi":            {"name":"RecoEmiss_phi",                 "title":"Reco missing energy #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoEmiss_theta":          {"name":"RecoEmiss_theta",               "title":"Reco missing energy #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "Jets_R5_eta":              {"name":"Jets_R5_eta",                 "title":"Jets_{R5} #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_theta":            {"name":"Jets_R5_theta",               "title":"Jets_{R5} #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "Jets_R5_phi":              {"name":"Jets_R5_phi",                 "title":"Jets_{R5} #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "Jets_R5_sel_eta":          {"name":"Jets_R5_sel_eta",                 "title":"not hadronic #tau Jets_{R5} #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "Jets_R5_sel_theta":        {"name":"Jets_R5_sel_theta",               "title":"not hadronic #tau Jets_{R5} #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "Jets_R5_sel_phi":          {"name":"Jets_R5_sel_phi",                 "title":"not hadronic #tau Jets_{R5} #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "TauFromJet_R5_theta":      {"name":"TauFromJet_R5_theta",               "title":"#tau from jet_{R5} #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    ...
    "TagJet_R5_eta":              {"name":"TagJet_R5_eta",                 "title":"R5 jet #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "TagJet_R5_theta":            {"name":"TagJet_R5_theta",               "title":"R5 jet #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "TagJet_R5_phi":              {"name":"TagJet_R5_phi",                 "title":"R5 jet #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "LeadingPi_eta":           {"name":"LeadingPi_eta",                 "title":"Leading charged particle in R5 jet #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "LeadingPi_theta":         {"name":"LeadingPi_theta",               "title":"Leading charged particle in R5 jet #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "LeadingPi_phi":           {"name":"LeadingPi_phi",                 "title":"Leading charged particle in R5 jet #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "TauTag_eta":              {"name":"TauTag_eta",                 "title":"#tau from tagged jet #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauTag_theta":            {"name":"TauTag_theta",               "title":"#tau from tagged jet #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "TauTag_phi":              {"name":"TauTag_phi",                 "title":"#tau from tagged jet #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "QuarkTag_eta":              {"name":"QuarkTag_eta",                 "title":"Quark jet from tagged jet #eta",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    "QuarkTag_theta":            {"name":"QuarkTag_theta",               "title":"Quark jet from tagged jet #theta",                         "bin":32, "xmin":0,"xmax":3.2},
    "QuarkTag_phi":              {"name":"QuarkTag_phi",                 "title":"Quark jet from tagged jet #phi",                           "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoZ_eta":                {"name":"RecoZ_eta",                "title":"Reco Z #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZ_phi":                {"name":"RecoZ_phi",                "title":"Reco Z #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZ_theta":              {"name":"RecoZ_theta",              "title":"Reco Z #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoZLead_eta":              {"name":"RecoZLead_eta",                "title":"Reco leading Z daughter #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZLead_phi":              {"name":"RecoZLead_phi",                "title":"Reco leading Z daughter #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZLead_theta":            {"name":"RecoZLead_theta",              "title":"Reco leading Z daughter #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoZSub_eta":               {"name":"RecoZSub_eta",                "title":"Reco subleading Z daughter #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZSub_phi":               {"name":"RecoZSub_phi",                "title":"Reco subleading Z daughter #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZSub_theta":             {"name":"RecoZSub_theta",              "title":"Reco subleading Z daughter #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoZP_eta":              {"name":"RecoZP_eta",                "title":"Reco positive Z daughter #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZP_phi":              {"name":"RecoZP_phi",                "title":"Reco positive Z daughter #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZP_theta":            {"name":"RecoZP_theta",              "title":"Reco positive Z daughter #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoZM_eta":               {"name":"RecoZM_eta",                "title":"Reco negative Z daughter #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZM_phi":               {"name":"RecoZM_phi",                "title":"Reco negative Z daughter #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZM_theta":             {"name":"RecoZM_theta",              "title":"Reco negative Z daughter #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "RecoH_eta":                {"name":"RecoH_eta",                "title":"Reco H #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoH_phi":                {"name":"RecoH_phi",                "title":"Reco H #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoH_theta":              {"name":"RecoH_theta",              "title":"Reco H #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "TauLead_eta":              {"name":"TauLead_eta",                "title":"#tau_{leading} #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauLead_phi":              {"name":"TauLead_phi",                "title":"#tau_{leading} #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauLead_theta":            {"name":"TauLead_theta",              "title":"#tau_{leading} #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "TauSub_eta":               {"name":"TauSub_eta",                "title":"#tau_{subleading} #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauSub_phi":               {"name":"TauSub_phi",                "title":"#tau_{subleading} #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauSub_theta":             {"name":"TauSub_theta",              "title":"#tau_{subleading} #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "TauP_eta":              {"name":"TauP_eta",                "title":"#tau^{+} #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauP_phi":              {"name":"TauP_phi",                "title":"#tau^{+} #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauP_theta":            {"name":"TauP_theta",              "title":"#tau^{+} #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "TauM_eta":               {"name":"TauM_eta",                "title":"#tau^{-} #eta",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauM_phi":               {"name":"TauM_phi",                "title":"#tau^{-} #phi",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "TauM_theta":             {"name":"TauM_theta",              "title":"#tau^{-} #theta",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "Tau_DPhi":         {"name":"Tau_DPhi",           "title":"#Delta#phi(#tau#tau)",                "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "Tau_DEta":                             {"name":"Tau_DEta",           "title":"Reco di-#tau #Delta#eta",                  "bin":64, "xmin":-3.2,"xmax":3.2},

    "RecoZDaughter_DPhi":         {"name":"RecoZDaughter_DPhi",           "title":"#Delta#phi(ll)",                "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "RecoZDaughter_DEta":                   {"name":"RecoZDaughter_DEta",           "title":"Reco Z daughters #Delta#eta",                  "bin":64, "xmin":-3.2,"xmax":3.2},

    "Recoil":                   {"name":"Recoil",                   "title":"M_{recoil} [GeV]",                     "bin":80, "xmin":80., "xmax":320.},
    "Collinear_mass":           {"name":"Collinear_mass",           "title":"M_{collinear} [GeV]",                  "bin":150, "xmin":50., "xmax":200.},

    #### CP variables

    "Tau_DEta_y":                             {"name":"Tau_DEta_y",           "title":"Reco di-#tau #Delta#eta",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "Tau_DPhi_y":                           {"name":"Tau_DPhi_y",           "title":"#Delta#phi(#tau#tau)",                "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZDaughter_DEta_y":                 {"name":"RecoZDaughter_DEta_y",           "title":"Reco Z daughters #Delta#eta",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "RecoZDaughter_DPhi_y":                 {"name":"RecoZDaughter_DPhi_y",           "title":"Reco Z daughters #Delta#phi",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "HRF_TauLead_eta":                {"name":"HRF_TauLead_eta",                "title":"Reco #tau_{leading} #eta in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauLead_phi":                {"name":"HRF_TauLead_phi",                "title":"Reco #tau_{leading} #phi in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauLead_theta":              {"name":"HRF_TauLead_theta",              "title":"Reco #tau_{leading} #theta in H rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "HRF_TauSub_eta":                {"name":"HRF_TauSub_eta",                "title":"Reco #tau_{subleading} #eta in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauSub_phi":                {"name":"HRF_TauSub_phi",                "title":"Reco #tau_{subleading} #phi in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauSub_theta":              {"name":"HRF_TauSub_theta",              "title":"Reco #tau_{subleading} #theta in H rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "HRF_TauP_eta":                {"name":"HRF_TauP_eta",                "title":"Reco #tau^{+} #eta in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauP_phi":                {"name":"HRF_TauP_phi",                "title":"Reco #tau^{+} #phi in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauP_theta":              {"name":"HRF_TauP_theta",              "title":"Reco #tau^{+} #theta in H rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "HRF_TauM_eta":                {"name":"HRF_TauM_eta",                "title":"Reco #tau^{-} #eta in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauM_phi":                {"name":"HRF_TauM_phi",                "title":"Reco #tau^{-} #phi in H rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_TauM_theta":              {"name":"HRF_TauM_theta",              "title":"Reco #tau^{-} #theta in H rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    "HRF_TauM_y":                  {"name":"HRF_TauM_y",                  "title":"Reco #tau^{-} rapidity in H rest frame",               "bin":40, "xmin":-4., "xmax":4.},

    "HRF_Tau_DEta":                   {"name":"HRF_Tau_DEta",           "title":"Reco di-#tau #Delta#eta in H rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_Tau_DPhi":           {"name":"HRF_Tau_DPhi",           "title":"Reco di-#tau #Delta#phi in H rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_Tau_DEta_y":                   {"name":"HRF_Tau_DEta_y",           "title":"Reco di-#tau #Delta#eta in H rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "HRF_Tau_DPhi_y":           {"name":"HRF_Tau_DPhi_y",           "title":"Reco di-#tau #Delta#phi in H rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    ...
    "ZRF_RecoZLead_eta":                {"name":"ZRF_RecoZLead_eta",                "title":"Reco leading Z daughter #eta in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZLead_phi":                {"name":"ZRF_RecoZLead_phi",                "title":"Reco leading Z daughter #phi in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZLead_theta":              {"name":"ZRF_RecoZLead_theta",              "title":"Reco leading Z daughter #theta in Z rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "ZRF_RecoZSub_eta":                {"name":"ZRF_RecoZSub_eta",                "title":"Reco subleading Z daughter #eta in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZSub_phi":                {"name":"ZRF_RecoZSub_phi",                "title":"Reco subleading Z daughter #phi in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZSub_theta":              {"name":"ZRF_RecoZSub_theta",              "title":"Reco subleading Z daughter #theta in Z rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "ZRF_RecoZP_eta":                {"name":"ZRF_RecoZP_eta",                "title":"Reco positive Z daughter #eta in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZP_phi":                {"name":"ZRF_RecoZP_phi",                "title":"Reco positive Z daughter #phi in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZP_theta":              {"name":"ZRF_RecoZP_theta",              "title":"Reco positive Z daughter #theta in Z rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    ...
    "ZRF_RecoZM_eta":                {"name":"ZRF_RecoZM_eta",                "title":"Reco negative Z daughter #eta in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZM_phi":                {"name":"ZRF_RecoZM_phi",                "title":"Reco negative Z daughter #phi in Z rest frame",                   "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZM_theta":              {"name":"ZRF_RecoZM_theta",              "title":"Reco negative Z daughter #theta in Z rest frame",                 "bin":32, "xmin":0,"xmax":3.2},
    "ZRF_RecoZM_y":                  {"name":"ZRF_RecoZM_y",                  "title":"Reco negative Z daughter rapidity in Z rest frame",               "bin":40, "xmin":-4., "xmax":4.},

    "ZRF_RecoZDaughter_DEta":                   {"name":"ZRF_RecoZDaughter_DEta",           "title":"Reco Z daughters #Delta#eta in Z rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZDaughter_DPhi":           {"name":"ZRF_RecoZDaughter_DPhi",           "title":"Reco Z daughters #Delta#phi in Z rest frame",          "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZDaughter_DEta_y":                   {"name":"ZRF_RecoZDaughter_DEta_y",           "title":"Reco Z daughters #Delta#eta in Z rest frame",                  "bin":64, "xmin":-3.2,"xmax":3.2},
    "ZRF_RecoZDaughter_DPhi_y":           {"name":"ZRF_RecoZDaughter_DPhi_y",           "title":"Reco Z daughters #Delta#phi in Z rest frame",          "bin":64, "xmin":-3.2,"xmax":3.2},

    "RecoThetastar":           {"name":"RecoThetastar",         "title":"Reco #theta^{*}",                 "bin":128, "xmin":-3.2,"xmax":3.2},
    "RecoTheta2":              {"name":"RecoTheta2",            "title":"Reco #theta_{2}",                 "bin":128, "xmin":-3.2,"xmax":3.2},
    "RecoPhi1":                {"name":"RecoPhi1",              "title":"Reco #phi_{1}",                   "bin":128, "xmin":-3.2,"xmax":3.2},
    "RecoPhi":                 {"name":"RecoPhi",               "title":"Reco #phi",                       "bin":128, "xmin":-3.2,"xmax":3.2},
    "RecoTheta1":              {"name":"RecoTheta1",            "title":"Reco #theta_{1}",                 "bin":128, "xmin":-3.2,"xmax":3.2},

    "RecoThetastar_cos":           {"name":"RecoThetastar_cos",         "title":"Reco cos#theta^{*}",                  "bin":100, "xmin":-1.,"xmax":1.},
    "RecoTheta2_cos":              {"name":"RecoTheta2_cos",            "title":"Reco cos#theta_{2}",                  "bin":100, "xmin":-1.,"xmax":1.},
    "RecoPhi1_cos":                {"name":"RecoPhi1_cos",              "title":"Reco cos#phi_{1}",                    "bin":100, "xmin":-1.,"xmax":1.},
    "RecoPhi_cos":                 {"name":"RecoPhi_cos",               "title":"Reco cos#phi",                        "bin":100, "xmin":-1.,"xmax":1.},
    "RecoTheta1_cos":              {"name":"RecoTheta1_cos",            "title":"Reco cos#theta_{1}",                  "bin":100, "xmin":-1.,"xmax":1.},
