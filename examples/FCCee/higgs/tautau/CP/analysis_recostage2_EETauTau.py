...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("FourLeptons",       "(n_TauFromJet_R5==0 and n_TagJet_R5_sel==0 and ((n_RecoElectrons_sel==2 and n_RecoMuons_sel==2 and (RecoElectron_sel_charge.at(0) + RecoElectron_sel_charge.at(1))==0 and (RecoMuon_sel_charge.at(0) + RecoMuon_sel_charge.at(1))==0) or (n_RecoElectrons_sel==3 and n_RecoMuons_sel==1 and (RecoLepton_sel_charge.at(0) + RecoLepton_sel_charge.at(1) + RecoLepton_sel_charge.at(2) + RecoLepton_sel_charge.at(3))==0) \
                                                 or (n_RecoElectrons_sel==4 and n_RecoMuons_sel==0 and (RecoLepton_sel_charge.at(0) + RecoLepton_sel_charge.at(1) + RecoLepton_sel_charge.at(2) + RecoLepton_sel_charge.at(3))==0)) )*1.0")
                .Define("ThreeLeptons",      "(n_TauFromJet_R5==1 and n_TagJet_R5_sel==0 and ((n_RecoElectrons_sel==3 and n_RecoMuons_sel==0 and (RecoElectron_sel_charge.at(0) + RecoElectron_sel_charge.at(1) + RecoElectron_sel_charge.at(2) + TauFromJet_R5_charge.at(0))==0) or (n_RecoElectrons_sel==2 and n_RecoMuons_sel==1 and (RecoElectron_sel_charge.at(0) + RecoElectron_sel_charge.at(1))==0 and (RecoMuon_sel_charge.at(0) + TauFromJet_R5_charge.at(0))==0)))*1.0")
                .Define("TwoLeptons",        "(n_RecoElectrons_sel==2 and n_RecoMuons_sel==0 and n_TauFromJet_R5==2 and n_TagJet_R5_sel==0 and (RecoLepton_sel_charge.at(0) + RecoLepton_sel_charge.at(1))==0 and (TauFromJet_R5_charge.at(0) + TauFromJet_R5_charge.at(1))==0)*1.0")

                .Filter("FourLeptons==1 || ThreeLeptons==1 || TwoLeptons==1")
                ...
                .Define("RecoZH_idx",        "if (n_RecoLeptons_sel==4) return FCCAnalyses::ZHfunctions::FindBest_4(RecoLepton_sel_p4, RecoLepton_sel_charge, RecoLepton_sel_mass, 91.188, 125.25); \
                                                else if (n_RecoLeptons_sel==3) return FCCAnalyses::ZHfunctions::FindBest_3(RecoLepton_sel_p4, RecoLepton_sel_charge, RecoLepton_sel_mass, 91.188); else return std::vector<int>{0,1};")
                ...
                .Define("ChargedTauImpactP_p4",       "if (n_RecoLeptons_sel==2 && RecoChargedTauTrack_charge.at(0)==1) return ChargedTauImpact_p4.at(0); else if (n_RecoLeptons_sel==2 && RecoChargedTauTrack_charge.at(0)==-1) return ChargedTauImpact_p4.at(1);\
                                            else if (n_RecoLeptons_sel==3 && RecoChargedTauTrack_charge.at(0)==1) return ChargedTauImpact_p4.at(0);  else if (n_RecoLeptons_sel==3 && RecoChargedTauTrack_charge.at(0)==-1) return LeptonImpact_p4.at(RecoZH_idx[2]);\
                                             else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==1) return LeptonImpact_p4.at(RecoZH_idx[2]); else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==-1) return LeptonImpact_p4.at(RecoZH_idx[3]); else return TLorentzVector(0,0,0,0);")
                .Define("ChargedTauImpactM_p4",       "if (n_RecoLeptons_sel==2 && RecoChargedTauTrack_charge.at(0)==1) return ChargedTauImpact_p4.at(1); else if (n_RecoLeptons_sel==2 && RecoChargedTauTrack_charge.at(0)==-1) return ChargedTauImpact_p4.at(0);\
                                            else if (n_RecoLeptons_sel==3 && RecoChargedTauTrack_charge.at(0)==1) return LeptonImpact_p4.at(RecoZH_idx[2]);  else if (n_RecoLeptons_sel==3 && RecoChargedTauTrack_charge.at(0)==-1) return ChargedTauImpact_p4.at(0);\
                                             else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==1) return LeptonImpact_p4.at(RecoZH_idx[3]); else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==-1) return LeptonImpact_p4.at(RecoZH_idx[2]); else return TLorentzVector(0,0,0,0);")
                .Define("Impact_p4",      "FCCAnalyses::ZHfunctions::build_p4_class(ChargedTauImpactP_p4, ChargedTauImpactM_p4)")

                .Define("RecoPiP_p4",       "if (n_RecoLeptons_sel==2 && ChargedTau_charge.at(0)==1) return ChargedTau_p4.at(0); else if (n_RecoLeptons_sel==2 && ChargedTau_charge.at(0)==-1) return ChargedTau_p4.at(1);\
                                            else if (n_RecoLeptons_sel==3 && ChargedTau_charge.at(0)==1) return ChargedTau_p4.at(0);  else if (n_RecoLeptons_sel==3 && ChargedTau_charge.at(0)==-1) return RecoLepton_sel_p4.at(RecoZH_idx[2]);\
                                             else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==1) return RecoLepton_sel_p4.at(RecoZH_idx[2]); else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==-1) return RecoLepton_sel_p4.at(RecoZH_idx[3]); else return TLorentzVector(0,0,0,0);")
                .Define("RecoPiM_p4",       "if (n_RecoLeptons_sel==2 && ChargedTau_charge.at(0)==1) return ChargedTau_p4.at(1); else if (n_RecoLeptons_sel==2 && ChargedTau_charge.at(0)==-1) return ChargedTau_p4.at(0);\
                                            else if (n_RecoLeptons_sel==3 && ChargedTau_charge.at(0)==1) return RecoLepton_sel_p4.at(RecoZH_idx[2]);  else if (n_RecoLeptons_sel==3 && ChargedTau_charge.at(0)==-1) return ChargedTau_p4.at(0);\
                                             else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==1) return RecoLepton_sel_p4.at(RecoZH_idx[3]); else if (n_RecoLeptons_sel==4 && RecoLepton_sel_charge.at(RecoZH_idx[2])==-1) return RecoLepton_sel_p4.at(RecoZH_idx[2]); else return TLorentzVector(0,0,0,0);")
                .Define("RecoPi_p4",      "FCCAnalyses::ZHfunctions::build_p4_class(RecoPiP_p4, RecoPiM_p4)")

                .Define("RecoPi0P_p4",     "if (n_RecoLeptons_sel==2 && NeutralTau_charge.at(0)==1) return NeutralTau_p4.at(0); else if (n_RecoLeptons_sel==2 && NeutralTau_charge.at(1)==1) return NeutralTau_p4.at(1);\
                                            else if (n_RecoLeptons_sel==3 && NeutralTau_charge.at(0)==1) return NeutralTau_p4.at(0); else return TLorentzVector(0,0,0,0);")
                .Define("RecoPi0M_p4",       "if (n_RecoLeptons_sel==2 && NeutralTau_charge.at(0)==1) return NeutralTau_p4.at(1); else if (n_RecoLeptons_sel==2 && NeutralTau_charge.at(1)==1) return NeutralTau_p4.at(0);\
                                            else if (n_RecoLeptons_sel==3 && NeutralTau_charge.at(0)==-1) return NeutralTau_p4.at(0); else return TLorentzVector(0,0,0,0);")
                .Define("RecoPi0_p4",      "FCCAnalyses::ZHfunctions::build_p4_class(RecoPi0P_p4, RecoPi0M_p4)")

                .Define("RecoZ1_p4",      "TLorentzVector(RecoLepton_sel_px.at(RecoZH_idx[0]), RecoLepton_sel_py.at(RecoZH_idx[0]), RecoLepton_sel_pz.at(RecoZH_idx[0]), RecoLepton_sel_e.at(RecoZH_idx[0]))")
                .Define("RecoZ2_p4",      "TLorentzVector(RecoLepton_sel_px.at(RecoZH_idx[1]), RecoLepton_sel_py.at(RecoZH_idx[1]), RecoLepton_sel_pz.at(RecoZH_idx[1]), RecoLepton_sel_e.at(RecoZH_idx[1]))")
                ...
                .Define("RecoTau1_p4",      "if (n_RecoLeptons_sel>2) return TLorentzVector(RecoLepton_sel_px.at(RecoZH_idx[2]), RecoLepton_sel_py.at(RecoZH_idx[2]), RecoLepton_sel_pz.at(RecoZH_idx[2]), RecoLepton_sel_e.at(RecoZH_idx[2])); \
                                             else return TLorentzVector(TauFromJet_R5_px.at(0), TauFromJet_R5_py.at(0), TauFromJet_R5_pz.at(0), TauFromJet_R5_e.at(0));")
                .Define("RecoTau2_p4",      "if (n_RecoLeptons_sel==4) return TLorentzVector(RecoLepton_sel_px.at(RecoZH_idx[3]), RecoLepton_sel_py.at(RecoZH_idx[3]), RecoLepton_sel_pz.at(RecoZH_idx[3]), RecoLepton_sel_e.at(RecoZH_idx[3])); \
                                            else if (n_RecoLeptons_sel==3) return TLorentzVector(TauFromJet_R5_px.at(0), TauFromJet_R5_py.at(0), TauFromJet_R5_pz.at(0), TauFromJet_R5_e.at(0)); \
                                            else if (n_RecoLeptons_sel==2) return TLorentzVector(TauFromJet_R5_px.at(1), TauFromJet_R5_py.at(1), TauFromJet_R5_pz.at(1), TauFromJet_R5_e.at(1)); else return TLorentzVector(0,0,0,0);")
                ...
                #.Filter("RecoPi0P_p4.E()>0 && RecoPi0M_p4.E()>0")
                ...
                .Define("PhiCP_y",        "if ((y_tau>=0 && n_RecoLeptons!=3) || (y_tau<0 && n_RecoLeptons==3)) return Phi_ZMF; else return (-3.1415 + Phi_ZMF);")
