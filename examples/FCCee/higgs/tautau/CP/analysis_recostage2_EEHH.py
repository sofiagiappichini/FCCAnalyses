...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("HRF_Tau_p4",    "FCCAnalyses::ZHfunctions::boosted_p4(- RecoH_p4.at(0), RecoTau_p4)")
                ...
                .Define("HRF_TauP_p4",     "if (HiggsTau_charge.at(0)==1) return HRF_Tau_p4.at(0); else return HRF_Tau_p4.at(1);")
                ...
                .Define("HRF_TauM_p4",     "if (HiggsTau_charge.at(0)==1) return HRF_Tau_p4.at(1); else return HRF_Tau_p4.at(0);")
                ...
                # with explicitely reconstructed taus, selecting the pi nu decay, the tau variable is the pion itself so i can only boost that in the higgs rest frame 

                #.Define("TauPRF_GenPiP_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauP_p4, GenPiP_p4)")
                #.Define("TauPRF_GenPi0P_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauP_p4, GenPi0P_p4)")
                #.Define("TauPRF_GenNuP_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauP_p4, GenNuP_p4)")

                #.Define("TauMRF_GenPiM_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauM_p4, GenPiM_p4)")
                #.Define("TauMRF_GenPi0M_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauM_p4, GenPi0M_p4)")
                #.Define("TauMRF_GenNuM_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- TauM_p4, GenNuM_p4)")
                ...
                .Define("hP_p3",        "HRF_TauP_p4.Vect()")
                .Define("hM_p3",        "HRF_TauM_p4.Vect()")

                # also now there is no need to get the products again but the cross of the pions is already the vector that i need

                #.Define("hPnorm",       "(( HRF_TauM_p4.Vect() ).Cross( hP_p3 )).Unit()")
                #.Define("hMnorm",       "(( HRF_TauM_p4.Vect() ).Cross( hM_p3 )).Unit()")

                .Define("hh_norm",       "hP_p3.Cross(hM_p3)")
                .Define("CosDeltaPhi",        "hPnorm.Dot(hMnorm)")
                .Define("SinDeltaPhi",       "hh_norm.Dot( (HRF_TauM_p4.Vect()).Unit() )")
