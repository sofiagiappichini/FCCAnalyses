...
outputDir = "/ceph/sgiappic/HiggsCP/CPReco/stage2_explicit_v3/"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("ZMF_p4",       "Higgs_p4")

                .Define("ZMF_RecoPiP_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, TauP_p4)")
                .Define("ZMF_ImpactP_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedTauImpactP_p4)")

                .Define("ZMF_RecoPiM_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, TauM_p4)")
                .Define("ZMF_ImpactM_p4",    "FCCAnalyses::ZHfunctions::boosted_p4_single(- ZMF_p4, ChargedTauImpactM_p4)")
