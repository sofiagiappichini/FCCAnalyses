...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("TauLeptons_p4",  "FCCAnalyses::ZHfunctions::build_p4(TauLeptons_px, TauLeptons_py, TauLeptons_pz, TauLeptons_e)")
                ...
                .Define("n_Jets_kt2_sel_constituents",        "n_Jets_kt2_constituents[TauFromJet_kt2_type_sel<0 ]")
                .Define("n_Jets_kt2_sel_charged_constituents",        "n_Jets_kt2_charged_constituents[TauFromJet_kt2_type_sel<0 ]")
                .Define("n_Jets_kt2_sel_neutral_constituents",        "n_Jets_kt2_neutral_constituents[TauFromJet_kt2_type_sel<0 ]")
                ...
                .Filter("n_TauFromJet_kt2==0 && n_Jets_kt2_sel==2 && n_RecoLeptons_sel==2")
                # no need to filter on the charges of the leading and subleading because they are built opposite anyway

                ##################

                .Define("RecoZ1_p4",      "TLorentzVector(Jets_kt2_sel_px.at(0), Jets_kt2_sel_py.at(0), Jets_kt2_sel_pz.at(0), Jets_kt2_sel_e.at(0))")
                .Define("RecoZ2_p4",      "TLorentzVector(Jets_kt2_sel_px.at(1), Jets_kt2_sel_py.at(1), Jets_kt2_sel_pz.at(1), Jets_kt2_sel_e.at(1))")
                .Define("RecoZ1_consituents",    "n_Jets_kt2_sel_constituents.at(0)")
                .Define("RecoZ2_consituents",    "n_Jets_kt2_sel_constituents.at(1)")
                .Define("RecoZ1_charged_consituents",    "n_Jets_kt2_sel_charged_constituents.at(0)")
                .Define("RecoZ2_charged_consituents",    "n_Jets_kt2_sel_charged_constituents.at(1)")
                .Define("RecoZ1_neutral_consituents",    "n_Jets_kt2_sel_neutral_constituents.at(0)")
                .Define("RecoZ2_neutral_consituents",    "n_Jets_kt2_sel_neutral_constituents.at(1)")
                ...
                .Define("RecoLeptonTrack",   "ReconstructedParticle2Track::getRP2TRK( TauLeptons, EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(TauLeptons,EFlowTrack_1)")
                .Define("RecoLeptonTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(TauLeptons,EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(TauLeptons,EFlowTrack_1)") #significance
                .Define("RecoLeptonTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(TauLeptons,EFlowTrack_1)")
                .Define("RecoLeptonTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(TauLeptons,EFlowTrack_1)")
                .Define("RecoLeptonTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(TauLeptons,EFlowTrack_1)")
                ...
                .Define("RecoPiP_p4",       "if (TauLeptons_charge.at(0)==1) return TauLeptons_p4.at(0); else return TauLeptons_p4.at(1);")
                .Define("RecoPiM_p4",       "if (TauLeptons_charge.at(0)==1) return TauLeptons_p4.at(1); else return TauLeptons_p4.at(0);")
