...
processList = {
    "mg_ee_fftata_sm_ecm240":{'chunks':1000},
}
processList_ = {
    #"mg_ee_fftata_ceHIm_m1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_sm_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__ceHIm_p1_p1_ecm240":{'chunks':1000},

    #"mg_ee_fftata_ceHIm__cHB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm__cHBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm__cHWB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm__cHW_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHIm__cHWtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHWB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHW_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_ceHRe__cHWtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB__cHBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB__cHWB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB__cHW_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB__cHWtil_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB_m1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHB_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHBtil__cHWB_p1_p1_ecm240":{'chunks':1000},
    #"mg_ee_fftata_cHBtil__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHBtil__cHW_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHBtil__cHWtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHBtil_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHBtil_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWB__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWB_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWB_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWBtil_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWBtil_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHW__cHWB_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHW__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHW__cHWtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHW_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHW_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWtil__cHWB_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWtil__cHWBtil_p1_p1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWtil_m1_ecm240":{'chunks':1000},
    "mg_ee_fftata_cHWtil_p1_ecm240":{'chunks':1000},
}
...
inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/MCgenCP/DelphesPythia8_EDM4HEP/NovCampaign/"
...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/CP/stage1_250530/ktN-explicit/QQ/HH"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                # now the leptons can really be whatever number and i don't care so no filtering

                .Define("RP_px_sel",          "ReconstructedParticle::get_px(ReconstructedParticles)")
                .Define("RP_py_sel",          "ReconstructedParticle::get_py(ReconstructedParticles)")
                .Define("RP_pz_sel",          "ReconstructedParticle::get_pz(ReconstructedParticles)")
                .Define("RP_e_sel",           "ReconstructedParticle::get_e(ReconstructedParticles)")
                .Define("RP_m_sel",           "ReconstructedParticle::get_mass(ReconstructedParticles)")
                .Define("RP_q_sel",           "ReconstructedParticle::get_charge(ReconstructedParticles)")
                # build pseudo jets with the RP, using the interface that takes px,py,pz,E
                .Define("pseudo_jets",  "JetClusteringUtils::set_pseudoJets(RP_px_sel, RP_py_sel, RP_pz_sel, RP_e_sel)" )

                ### Durham algo, exclusive clustering (first number 2) N_jets=2 (second number), E-scheme=0 (third and forth numbers) ###
                .Define( "FCCAnalysesJets_ee_kt",  "JetClustering::clustering_ee_kt(2, 4, 1, 0)(pseudo_jets)" )
                .Define("Jets_kt4",  "JetClusteringUtils::get_pseudoJets( FCCAnalysesJets_ee_kt )")
                .Define("Jet_GetConstituents_kt4","JetClusteringUtils::get_constituents(FCCAnalysesJets_ee_kt)") # constituents indices
                .Define("Jets_Constituents_kt4", "JetConstituentsUtils::build_constituents_cluster(ReconstructedParticles, Jet_GetConstituents_kt4)") #build jet constituents lists for tau reconstruction
                
		        .Define("Jets_kt4_e",      "JetClusteringUtils::get_e(Jets_kt4)")
                .Define("Jets_kt4_p",      "JetClusteringUtils::get_p(Jets_kt4)") #momentum p
                .Define("Jets_kt4_pt",      "JetClusteringUtils::get_pt(Jets_kt4)") #transverse momentum pt
                .Define("Jets_kt4_px",      "JetClusteringUtils::get_px(Jets_kt4)")
                .Define("Jets_kt4_py",      "JetClusteringUtils::get_py(Jets_kt4)")
                .Define("Jets_kt4_pz",      "JetClusteringUtils::get_pz(Jets_kt4)")
		        .Define("Jets_kt4_eta",     "JetClusteringUtils::get_eta(Jets_kt4)") #pseudorapidity eta
                .Define("Jets_kt4_theta",   "JetClusteringUtils::get_theta(Jets_kt4)")
		        .Define("Jets_kt4_phi",     "JetClusteringUtils::get_phi(Jets_kt4)") #polar angle in the transverse plane phi
                .Define("Jets_kt4_mass",      "JetClusteringUtils::get_m(Jets_kt4)")
                .Define("n_Jets_kt4_constituents",        "JetConstituentsUtils::get_n_constituents(Jets_Constituents_kt4)")
                .Define("n_Jets_kt4_charged_constituents",        "JetConstituentsUtils::get_ncharged_constituents(Jets_Constituents_kt4)")
                .Define("n_Jets_kt4_neutral_constituents",        "JetConstituentsUtils::get_nneutral_constituents(Jets_Constituents_kt4)")
                .Define("n_Jets_kt4", "Jets_kt4_e.size()")

                .Define("TauFromJet_kt4", "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt4, 0)") 
                ...
                .Define("Jets_kt4_sel_e",      "Jets_kt4_e[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_p",      "Jets_kt4_p[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_pt",      "Jets_kt4_pt[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_px",      "Jets_kt4_px[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_py",      "Jets_kt4_py[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_pz",      "Jets_kt4_pz[TauFromJet_kt4_type_sel<0 ]")
		        .Define("Jets_kt4_sel_eta",     "Jets_kt4_eta[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_theta",   "Jets_kt4_theta[TauFromJet_kt4_type_sel<0 ]")
		        .Define("Jets_kt4_sel_phi",     "Jets_kt4_phi[TauFromJet_kt4_type_sel<0 ]")
                .Define("Jets_kt4_sel_mass",      "Jets_kt4_mass[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_Jets_kt4_sel_constituents",        "n_Jets_kt4_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_Jets_kt4_sel_charged_constituents",        "n_Jets_kt4_charged_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_Jets_kt4_sel_neutral_constituents",        "n_Jets_kt4_neutral_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_Jets_kt4_sel", "Jets_kt4_sel_e.size()")

                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt4_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt4, 3)")
                ...
                .Define("NeutralTau_kt4_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt4, 4)")
                ...
                .Filter("n_TauFromJet_kt4==2 && n_Jets_kt4_sel==2 && n_RecoLeptons_sel==0")
                .Filter("(TauFromJet_kt4_charge.at(0) + TauFromJet_kt4_charge.at(1))==0") 

                #########################

                .Define("RecoZ1_p4",      "TLorentzVector(Jets_kt4_sel_px.at(0), Jets_kt4_sel_py.at(0), Jets_kt4_sel_pz.at(0), Jets_kt4_sel_e.at(0))")
                .Define("RecoZ2_p4",      "TLorentzVector(Jets_kt4_sel_px.at(1), Jets_kt4_sel_py.at(1), Jets_kt4_sel_pz.at(1), Jets_kt4_sel_e.at(1))")
                .Define("RecoZ1_consituents",    "n_Jets_kt4_sel_constituents.at(0)")
                .Define("RecoZ2_consituents",    "n_Jets_kt4_sel_constituents.at(1)")
                .Define("RecoZ1_charged_consituents",    "n_Jets_kt4_sel_charged_constituents.at(0)")
                .Define("RecoZ2_charged_consituents",    "n_Jets_kt4_sel_charged_constituents.at(1)")
                .Define("RecoZ1_neutral_consituents",    "n_Jets_kt4_sel_neutral_constituents.at(0)")
                .Define("RecoZ2_neutral_consituents",    "n_Jets_kt4_sel_neutral_constituents.at(1)")
                ...
                .Define("RecoTau1_p4",      "TLorentzVector(TauFromJet_kt4_px.at(0), TauFromJet_kt4_py.at(0), TauFromJet_kt4_pz.at(0), TauFromJet_kt4_e.at(0))")
                .Define("RecoTau2_p4",      "TLorentzVector(TauFromJet_kt4_px.at(1), TauFromJet_kt4_py.at(1), TauFromJet_kt4_pz.at(1), TauFromJet_kt4_e.at(1))")
                .Define("RecoTau1_type",        "TauFromJet_kt4_type.at(0)")
                .Define("RecoTau2_type",        "TauFromJet_kt4_type.at(1)")
                ...
                .Define("TauP_p4","if (TauFromJet_kt4_charge.at(0)==1) return RecoTau1_p4; else return RecoTau2_p4;")
                ...
                .Define("TauP_type","if (TauFromJet_kt4_charge.at(0)==1) return RecoTau1_type; else return RecoTau2_type;")

                .Define("TauM_p4",       "if (TauFromJet_kt4_charge.at(0)==1) return RecoTau2_p4; else return RecoTau1_p4;")
                ...
                .Define("TauM_type","if (TauFromJet_kt4_charge.at(0)==1) return RecoTau2_type; else return RecoTau1_type;")
                ...
                .Define("RecoChargedTauTrack",   "ReconstructedParticle2Track::getRP2TRK(ChargedTau_kt4, EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(ChargedTau_kt4,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(ChargedTau_kt4,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(ChargedTau_kt4,EFlowTrack_1)") #significance
                .Define("RecoChargedTauTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(ChargedTau_kt4,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(ChargedTau_kt4,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(ChargedTau_kt4,EFlowTrack_1)")

                .Define("ChargedTauImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(ChargedTau_kt4_p4, RecoChargedTauTrack_D0, RecoChargedTauTrack_Z0)")
                ...
                # select quark jets
                .Define("Quark_constituents",       "Jets_Constituents_kt4[TauFromJet_kt4_type_sel<0]")
                # then flatten the particles
                .Define("Flat_quark_constituents",      "FCCAnalyses::ZHfunctions::flatten_part(Quark_constituents)")
                # get the particles' tracks
                .Define("Quark_tracks",   "ReconstructedParticle2Track::getRP2TRK(Flat_quark_constituents, EFlowTrack_1)")
                ...
                .Define("RecoPiP_p4",       "if (ChargedTau_kt4_charge.at(0)==1) return ChargedTau_kt4_p4.at(0); else return ChargedTau_kt4_p4.at(1);")
                .Define("RecoPiM_p4",       "if (ChargedTau_kt4_charge.at(0)==1) return ChargedTau_kt4_p4.at(1); else return ChargedTau_kt4_p4.at(0);")
                ...
                .Define("RecoPi0P_p4",       "if (NeutralTau_kt4_charge.at(0)==1) return NeutralTau_kt4_p4.at(0); else return NeutralTau_kt4_p4.at(1);")
                .Define("RecoPi0M_p4",       "if (NeutralTau_kt4_charge.at(0)==1) return NeutralTau_kt4_p4.at(1); else return NeutralTau_kt4_p4.at(0);")
