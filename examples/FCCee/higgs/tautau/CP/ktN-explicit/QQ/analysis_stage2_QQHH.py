...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("TauFromJet_kt4", "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 0)".format(jetClusteringHelper_kt4.constituents)) 
                ...
                .Define("TagJet_kt4_sel_e",      "TagJet_kt4_e[TauFromJet_kt4_type_sel<0 ]")
                .Define("TagJet_kt4_sel_p",      "TagJet_kt4_p[TauFromJet_kt4_type_sel<0 ]")
                .Define("TagJet_kt4_sel_pt",      "TagJet_kt4_pt[TauFromJet_kt4_type_sel<0 ]")
                ...
                .Define("n_TagJet_kt4_sel_constituents",        "n_TagJet_kt4_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_TagJet_kt4_sel_charged_constituents",        "n_TagJet_kt4_charged_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_TagJet_kt4_sel_neutral_constituents",        "n_TagJet_kt4_neutral_constituents[TauFromJet_kt4_type_sel<0 ]")
                .Define("n_TagJet_kt4_sel", "TagJet_kt4_sel_e.size()")

                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt4_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 1)".format(jetClusteringHelper_kt4.constituents))
                ...
                #get the neutral hadronic system for the tau jet, all in one "particle" variable, photons are kept separetely but would be related in pairs to pi0
                .Define("NeutralTau_kt4_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 2)".format(jetClusteringHelper_kt4.constituents))
        ...
        df2 = (df2
                ...
                .Define("TauTag_px",      "TagJet_kt4_px[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_py",      "TagJet_kt4_py[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_pz",      "TagJet_kt4_pz[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_pt",      "TagJet_kt4_pt[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_p",      "TagJet_kt4_p[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_e",      "TagJet_kt4_e[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_phi",      "TagJet_kt4_phi[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_eta",      "TagJet_kt4_eta[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_theta",      "TagJet_kt4_theta[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_charge",      "TagJet_kt4_charge[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_mass",      "TagJet_kt4_mass[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isG",      "TagJet_kt4_isG[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isU",      "TagJet_kt4_isU[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isD",      "TagJet_kt4_isD[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isS",      "TagJet_kt4_isS[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isC",      "TagJet_kt4_isC[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isB",      "TagJet_kt4_isB[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_isTAU",      "TagJet_kt4_isTAU[TagJet_kt4_isTAU>0.5]")
                .Define("TauTag_flavor",      "TagJet_kt4_flavor[TagJet_kt4_isTAU>0.5]")
                .Define("n_TauTag_constituents",        "n_TagJet_kt4_constituents[TagJet_kt4_isTAU>0.5]")
                .Define("n_TauTag_charged_constituents",        "n_TagJet_kt4_charged_constituents[TagJet_kt4_isTAU>0.5]")
                .Define("n_TauTag_neutral_constituents",        "n_TagJet_kt4_neutral_constituents[TagJet_kt4_isTAU>0.5]")
                .Define("n_TauTag",          "TauTag_px.size()")

                .Define("QuarkTag_px",      "TagJet_kt4_px[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_py",      "TagJet_kt4_py[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_pz",      "TagJet_kt4_pz[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_pt",      "TagJet_kt4_pt[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_p",      "TagJet_kt4_p[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_e",      "TagJet_kt4_e[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_phi",      "TagJet_kt4_phi[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_eta",      "TagJet_kt4_eta[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_theta",      "TagJet_kt4_theta[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_charge",      "TagJet_kt4_charge[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_mass",      "TagJet_kt4_mass[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isG",      "TagJet_kt4_isG[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isU",      "TagJet_kt4_isU[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isD",      "TagJet_kt4_isD[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isS",      "TagJet_kt4_isS[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isC",      "TagJet_kt4_isC[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isB",      "TagJet_kt4_isB[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_isTAU",      "TagJet_kt4_isTAU[TagJet_kt4_isTAU<=0.5]")
                .Define("QuarkTag_flavor",      "TagJet_kt4_flavor[TagJet_kt4_isTAU<=0.5]")
                .Define("n_QuarkTag_constituents",        "n_TagJet_kt4_constituents[TagJet_kt4_isTAU<=0.5]")
                .Define("n_QuarkTag_charged_constituents",        "n_TagJet_kt4_charged_constituents[TagJet_kt4_isTAU<=0.5]")
                .Define("n_QuarkTag_neutral_constituents",        "n_TagJet_kt4_neutral_constituents[TagJet_kt4_isTAU<=0.5]")
                ...
                .Filter("n_TauFromJet_kt4==2 && n_TagJet_kt4_sel==2 && n_RecoLeptons_sel==0")
                .Filter("(TauFromJet_kt4_charge.at(0) + TauFromJet_kt4_charge.at(1))==0") 

                #########################

                .Define("RecoZ1_p4",      "TLorentzVector(TagJet_kt4_sel_px.at(0), TagJet_kt4_sel_py.at(0), TagJet_kt4_sel_pz.at(0), TagJet_kt4_sel_e.at(0))")
                .Define("RecoZ2_p4",      "TLorentzVector(TagJet_kt4_sel_px.at(1), TagJet_kt4_sel_py.at(1), TagJet_kt4_sel_pz.at(1), TagJet_kt4_sel_e.at(1))")
                .Define("RecoZ1_consituents",    "n_TagJet_kt4_sel_constituents.at(0)")
                .Define("RecoZ2_consituents",    "n_TagJet_kt4_sel_constituents.at(1)")
                .Define("RecoZ1_charged_consituents",    "n_TagJet_kt4_sel_charged_constituents.at(0)")
                .Define("RecoZ2_charged_consituents",    "n_TagJet_kt4_sel_charged_constituents.at(1)")
                .Define("RecoZ1_neutral_consituents",    "n_TagJet_kt4_sel_neutral_constituents.at(0)")
                .Define("RecoZ2_neutral_consituents",    "n_TagJet_kt4_sel_neutral_constituents.at(1)")
                ...
                # get jet consituents as a vetor of vector of particles
                .Define("Jet_consituents",      "{}".format(jetClusteringHelper_kt4.constituents))
                # select quark jets
                .Define("Quark_constituents",       "Jet_consituents[TauFromJet_kt4_type_sel<0]")
    ...
    def output():
        ...
        branchList = [
            ...
            "TagJet_kt4_sel_phi",     
            "TagJet_kt4_sel_mass", 
            "n_TagJet_kt4_sel_constituents",   
            "n_TagJet_kt4_sel_charged_constituents",   
            "n_TagJet_kt4_sel_neutral_constituents",       
            "n_TagJet_kt4_sel",
