...
cutList = {
    ...
    #"selReco_0.95BDT":"BDT_score>0.95",
    #"selReco_0.995BDT":"BDT_score>0.995",
}
...
histoList = {
    ...
    #"Jets_kt4_e":                {"name":"Jets_kt4_e",                   "title":"kt4 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},   
    #"Jets_kt4_p":                {"name":"Jets_kt4_p",                   "title":"kt4 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    #"Jets_kt4_pt":               {"name":"Jets_kt4_pt",                  "title":"kt4 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    #"Jets_kt4_px":               {"name":"Jets_kt4_px",                  "title":"kt4 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_py":               {"name":"Jets_kt4_py",                  "title":"kt4 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_pz":               {"name":"Jets_kt4_pz",                  "title":"kt4 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_eta":              {"name":"Jets_kt4_eta",                 "title":"kt4 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    #"Jets_kt4_theta":            {"name":"Jets_kt4_theta",               "title":"kt4 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    #"Jets_kt4_phi":              {"name":"Jets_kt4_phi",                 "title":"kt4 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    #"Jets_kt4_mass":             {"name":"Jets_kt4_mass",                "title":"kt4 jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    #"n_Jets_kt4":                {"name":"n_Jets_kt4",                   "title":"Number of kt4 jet",                     "bin":5, "xmin":-0.5, "xmax":4.5},
    #"n_Jets_kt4_constituents":             {"name":"n_Jets_kt4_constituents",               "title":"kt4 jet constituents",                   "bin":20, "xmin":0., "xmax":20.},
    #"n_Jets_kt4_charged_constituents":             {"name":"n_Jets_kt4_charged_constituents",               "title":"kt4 jet charged constituents",                   "bin":20, "xmin":0., "xmax":20.},
    #"n_Jets_kt4_neutral_constituents":             {"name":"n_Jets_kt4_neutral_constituents",               "title":"kt4 jet neutral constituents",                   "bin":20, "xmin":0., "xmax":20.},

    "TauFromJet_kt4_p":          {"name":"TauFromJet_kt4_p",                   "title":"#tau from kt4 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_kt4_pt":         {"name":"TauFromJet_kt4_pt",                  "title":"#tau from kt4 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    "TauFromJet_kt4_px":         {"name":"TauFromJet_kt4_px",                  "title":"#tau from kt4 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_kt4_py":         {"name":"TauFromJet_kt4_py",                  "title":"#tau from kt4 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    "TauFromJet_kt4_pz":         {"name":"TauFromJet_kt4_pz",                  "title":"#tau from kt4 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    ...
    "TauFromJet_kt4_e":          {"name":"TauFromJet_kt4_e",                   "title":"#tau from kt4 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},
    ...
    #"Jets_kt4_sel_e":            {"name":"Jets_kt4_sel_e",                   "title":"Quark/gluon kt4 jet energy [GeV]",                   "bin":50,"xmin":0 ,"xmax":100},    
    #"Jets_kt4_sel_p":            {"name":"Jets_kt4_sel_p",                   "title":"Quark/gluon kt4 jet p [GeV]",                        "bin":50,"xmin":0 ,"xmax":100},
    #"Jets_kt4_sel_pt":           {"name":"Jets_kt4_sel_pt",                  "title":"Quark/gluon kt4 jet p_{T} [GeV]",                    "bin":50,"xmin":0 ,"xmax":100},
    #"Jets_kt4_sel_px":           {"name":"Jets_kt4_sel_px",                  "title":"Quark/gluon kt4 jet p_{x} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_sel_py":           {"name":"Jets_kt4_sel_py",                  "title":"Quark/gluon kt4 jet p_{y} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_sel_pz":           {"name":"Jets_kt4_sel_pz",                  "title":"Quark/gluon kt4 jet p_{z} [GeV]",                    "bin":50,"xmin":-100 ,"xmax":100},
    #"Jets_kt4_sel_eta":          {"name":"Jets_kt4_sel_eta",                 "title":"Quark/gluon kt4 jet #eta",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    #"Jets_kt4_sel_theta":        {"name":"Jets_kt4_sel_theta",               "title":"Quark/gluon kt4 jet #theta",                         "bin":16, "xmin":0,"xmax":3.2},
    #"Jets_kt4_sel_phi":          {"name":"Jets_kt4_sel_phi",                 "title":"Quark/gluon kt4 jet #phi",                           "bin":32, "xmin":-3.2,"xmax":3.2},
    #"Jets_kt4_sel_mass":         {"name":"Jets_kt4_sel_mass",                "title":"Quark/gluon kt4 jet mass [GeV]",                     "bin":20, "xmin":0., "xmax":2.},
    #"n_Jets_kt4_sel":            {"name":"n_Jets_kt4_sel",                   "title":"Number of Quark/gluon kt4 jet",                     "bin":7, "xmin":-0.5, "xmax":6.5},
