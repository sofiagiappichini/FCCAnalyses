...
processList = {
    "mg_ee_fftata_cehim-m1_ecm240":{},
    "mg_ee_fftata_cehre-m1_ecm240":{},
    "mg_ee_fftata_sm_ecm240":{},
    "mg_ee_fftata_cehim-p1_ecm240":{},
    "mg_ee_fftata_cehre-p1_ecm240":{},
}
...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/CP/stage1_250530/ktN-explicit/QQ/LH/"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("RecoLeading_p4",  "FCCAnalyses::ZHfunctions::build_p4(LeadingLepton_px, LeadingLepton_py, LeadingLepton_pz, LeadingLepton_e)")
                ...
                .Define( "FCCAnalysesJets_ee_kt",  "JetClustering::clustering_ee_kt(2, 3, 1, 0)(pseudo_jets)" )
                .Define("Jets_kt3",  "JetClusteringUtils::get_pseudoJets( FCCAnalysesJets_ee_kt )")
                .Define("Jet_GetConstituents_kt3","JetClusteringUtils::get_constituents(FCCAnalysesJets_ee_kt)") # constituents indices
                .Define("Jets_Constituents_kt3", "JetConstituentsUtils::build_constituents_cluster(ReconstructedParticlesJET, Jet_GetConstituents_kt3)") #build jet constituents lists for tau reconstruction
                
		        .Define("Jets_kt3_e",      "JetClusteringUtils::get_e(Jets_kt3)")
                .Define("Jets_kt3_p",      "JetClusteringUtils::get_p(Jets_kt3)") #momentum p
                .Define("Jets_kt3_pt",      "JetClusteringUtils::get_pt(Jets_kt3)") #transverse momentum pt
                .Define("Jets_kt3_px",      "JetClusteringUtils::get_px(Jets_kt3)")
                .Define("Jets_kt3_py",      "JetClusteringUtils::get_py(Jets_kt3)")
                .Define("Jets_kt3_pz",      "JetClusteringUtils::get_pz(Jets_kt3)")
		        .Define("Jets_kt3_eta",     "JetClusteringUtils::get_eta(Jets_kt3)") #pseudorapidity eta
                .Define("Jets_kt3_theta",   "JetClusteringUtils::get_theta(Jets_kt3)")
		        .Define("Jets_kt3_phi",     "JetClusteringUtils::get_phi(Jets_kt3)") #polar angle in the transverse plane phi
                .Define("Jets_kt3_mass",      "JetClusteringUtils::get_m(Jets_kt3)")
                .Define("n_Jets_kt3_constituents",        "JetConstituentsUtils::get_n_constituents(Jets_Constituents_kt3)")
                .Define("n_Jets_kt3_charged_constituents",        "JetConstituentsUtils::get_ncharged_constituents(Jets_Constituents_kt3)")
                .Define("n_Jets_kt3_neutral_constituents",        "JetConstituentsUtils::get_nneutral_constituents(Jets_Constituents_kt3)")
                .Define("n_Jets_kt3", "Jets_kt3_e.size()")

                .Define("TauFromJet_kt3", "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt3, 0)") 
                ...
                .Define("Jets_kt3_sel_e",      "Jets_kt3_e[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_p",      "Jets_kt3_p[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_pt",      "Jets_kt3_pt[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_px",      "Jets_kt3_px[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_py",      "Jets_kt3_py[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_pz",      "Jets_kt3_pz[TauFromJet_kt3_type_sel<0 ]")
		        .Define("Jets_kt3_sel_eta",     "Jets_kt3_eta[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_theta",   "Jets_kt3_theta[TauFromJet_kt3_type_sel<0 ]")
		        .Define("Jets_kt3_sel_phi",     "Jets_kt3_phi[TauFromJet_kt3_type_sel<0 ]")
                .Define("Jets_kt3_sel_mass",      "Jets_kt3_mass[TauFromJet_kt3_type_sel<0 ]")
                .Define("n_Jets_kt3_sel_constituents",        "n_Jets_kt3_constituents[TauFromJet_kt3_type_sel<0 ]")
                .Define("n_Jets_kt3_sel_charged_constituents",        "n_Jets_kt3_charged_constituents[TauFromJet_kt3_type_sel<0 ]")
                .Define("n_Jets_kt3_sel_neutral_constituents",        "n_Jets_kt3_neutral_constituents[TauFromJet_kt3_type_sel<0 ]")
                .Define("n_Jets_kt3_sel", "Jets_kt3_sel_e.size()")

                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt3_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt3, 3)")
                ...
                .Define("NeutralTau_kt3_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt3, 4)")
                ...
                .Filter("n_TauFromJet_kt3==1 && n_Jets_kt3_sel==2 && n_RecoLeptons_sel==1")
                .Filter("(TauFromJet_kt3_charge.at(0) + LeadingLepton_charge.at(0))==0") 

                ################################

                .Define("RecoZ1_p4",      "TLorentzVector(Jets_kt3_sel_px.at(0), Jets_kt3_sel_py.at(0), Jets_kt3_sel_pz.at(0), Jets_kt3_sel_e.at(0))")
                .Define("RecoZ2_p4",      "TLorentzVector(Jets_kt3_sel_px.at(1), Jets_kt3_sel_py.at(1), Jets_kt3_sel_pz.at(1), Jets_kt3_sel_e.at(1))")
                .Define("RecoZ1_consituents",    "n_Jets_kt3_sel_constituents.at(0)")
                .Define("RecoZ2_consituents",    "n_Jets_kt3_sel_constituents.at(1)")
                .Define("RecoZ1_charged_consituents",    "n_Jets_kt3_sel_charged_constituents.at(0)")
                .Define("RecoZ2_charged_consituents",    "n_Jets_kt3_sel_charged_constituents.at(1)")
                .Define("RecoZ1_neutral_consituents",    "n_Jets_kt3_sel_neutral_constituents.at(0)")
                .Define("RecoZ2_neutral_consituents",    "n_Jets_kt3_sel_neutral_constituents.at(1)")
                ...
                .Define("RecoTau1_p4",      "TLorentzVector(LeadingLepton_px.at(0), LeadingLepton_py.at(0), LeadingLepton_pz.at(0), LeadingLepton_e.at(0))")
                ...
                .Define("RecoTau1_type",        "if (LeadingLepton_mass.at(0)<0.05) return float(-0.11); else return float(-0.13);")
                .Define("RecoTau2_type",        "float(TauFromJet_kt3_type.at(0))")

                .Define("TauLepton_type",        "if (LeadingLepton_mass.at(0)<0.05) return float(-0.11); else return float(-0.13);")
                ...
                .Define("RecoChargedTauTrack",   "ReconstructedParticle2Track::getRP2TRK(ChargedTau_kt3, EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(ChargedTau_kt3,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(ChargedTau_kt3,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(ChargedTau_kt3,EFlowTrack_1)") #significance
                .Define("RecoChargedTauTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(ChargedTau_kt3,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(ChargedTau_kt3,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(ChargedTau_kt3,EFlowTrack_1)")

                .Define("ChargedTauImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(ChargedTau_kt3_p4, RecoChargedTauTrack_D0, RecoChargedTauTrack_Z0)")
             
                .Define("RecoLeptonTrack",   "ReconstructedParticle2Track::getRP2TRK( LeadingLepton, EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(LeadingLepton,EFlowTrack_1)")
                .Define("RecoLeptonTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(LeadingLepton,EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(LeadingLepton,EFlowTrack_1)") #significance
                .Define("RecoLeptonTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(LeadingLepton,EFlowTrack_1)")
                .Define("RecoLeptonTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(LeadingLepton,EFlowTrack_1)")
                .Define("RecoLeptonTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(LeadingLepton,EFlowTrack_1)")

                .Define("LeptonImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(RecoLeading_p4, RecoLeptonTrack_D0, RecoLeptonTrack_Z0)")
                ...
                # select quark jets
                .Define("Quark_constituents",       "Jets_Constituents_kt3[TauFromJet_kt3_type_sel<0]")
                ...
                .Define("ChargedTauImpactP_p4",       "if (RecoChargedTauTrack_charge.at(0)==1) return ChargedTauImpact_p4.at(0); else return LeptonImpact_p4.at(0);")
                .Define("RecoPiP_D0",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoChargedTauTrack_D0.at(0); else return RecoLeptonTrack_D0.at(0);")
                .Define("RecoPiP_Z0",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoChargedTauTrack_Z0.at(0); else return RecoLeptonTrack_Z0.at(0);")
                .Define("RecoPiP_D0sig",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoChargedTauTrack_D0sig.at(0); else return RecoLeptonTrack_D0sig.at(0);")
                .Define("RecoPiP_Z0sig",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoChargedTauTrack_Z0sig.at(0); else return RecoLeptonTrack_Z0sig.at(0);")
                ...
                .Define("ChargedTauImpactM_p4",       "if (RecoChargedTauTrack_charge.at(0)==1) return LeptonImpact_p4.at(0); else return ChargedTauImpact_p4.at(0);")
                .Define("RecoPiM_D0",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoLeptonTrack_D0.at(0); else return RecoChargedTauTrack_D0.at(0);")
                .Define("RecoPiM_Z0",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoLeptonTrack_Z0.at(0); else return RecoChargedTauTrack_Z0.at(0);")
                .Define("RecoPiM_D0sig",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoLeptonTrack_D0sig.at(0); else return RecoChargedTauTrack_D0sig.at(0);")
                .Define("RecoPiM_Z0sig",       "if (RecoChargedTauTrack_charge.at(0)==1) return RecoLeptonTrack_Z0sig.at(0); else return RecoChargedTauTrack_Z0sig.at(0);")
                ...
                .Define("RecoPiP_p4",       "if (ChargedTau_kt3_charge.at(0)==1) return ChargedTau_kt3_p4.at(0); else return RecoLeading_p4.at(0);")
                .Define("RecoPiM_p4",       "if (ChargedTau_kt3_charge.at(0)==1) return RecoLeading_p4.at(0); else return ChargedTau_kt3_p4.at(0);")
                ...
                .Define("RecoPi0P_p4",       "if (NeutralTau_kt3_charge.at(0)==1) return NeutralTau_kt3_p4.at(0); else return TLorentzVector(0.,0.,0.,0.);")
                .Define("RecoPi0M_p4",       "if (NeutralTau_kt3_charge.at(0)==1) return TLorentzVector(0.,0.,0.,0.); else return NeutralTau_kt3_p4.at(0);")
                ...
                ## opposite than the other channels because the number of leptons is odd
    ...
    def output():
        ...
        branchList = [
            ...
            "Jets_kt3_e",     
            "Jets_kt3_mass",   
            "n_Jets_kt3_constituents",   
            "n_Jets_kt3_charged_constituents",   
            "n_Jets_kt3_neutral_constituents",   
            "n_Jets_kt3",      
