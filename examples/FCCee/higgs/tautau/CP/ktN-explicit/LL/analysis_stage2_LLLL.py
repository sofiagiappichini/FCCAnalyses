...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/stage1_250302/ktN-explicit/LL/LL/"
...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("RecoTauLeptons", "ReconstructedParticle::merge(RecoLeptons.at(RecoZH_idx[2]), RecoLeptons.at(RecoZH_idx[3]))")
