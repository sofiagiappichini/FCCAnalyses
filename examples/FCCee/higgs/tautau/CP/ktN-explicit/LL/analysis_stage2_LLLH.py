...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("RecoLeptonTrack",   "ReconstructedParticle2Track::getRP2TRK( RecoLeptons.at(RecoZH_idx[2]), EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)")
                .Define("RecoLeptonTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)") #significance
                .Define("RecoLeptonTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)")
                .Define("RecoLeptonTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)")
                .Define("RecoLeptonTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(RecoLeptons.at(RecoZH_idx[2]),EFlowTrack_1)")
                ...
                .Define("Z1Track",      "ReconstructedParticle2Track::getRP2TRK( RecoLeptons.at(RecoZH_idx[0]), EFlowTrack_1)")
                .Define("Z2Track",      "ReconstructedParticle2Track::getRP2TRK( RecoLeptons.at(RecoZH_idx[1]), EFlowTrack_1)")
                ...
                .Define("RecoPiP_p4",       "if (ChargedTau_charge.at(0)==1) return ChargedTau_p4.at(0); else return RecoLepton_p4.at(RecoZH_idx[2]);")
                .Define("RecoPiM_p4",       "if (ChargedTau_charge.at(0)==1) return RecoLepton_p4.at(RecoZH_idx[2]); else return ChargedTau_p4.at(0);")
