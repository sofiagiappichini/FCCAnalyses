...
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/CP/stage1_250530/ktN-explicit/LL/LH"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                # three leptons in the whole event that make the Z boson, find the pair later, even if using tagged jets taus should not have leptons in the jets!!! should help with background rejection
                .Define("ThreeLeptons",    "(((n_RecoElectrons==3 and n_RecoMuons==0) or (n_RecoElectrons==0 and n_RecoMuons==3)) and abs(RecoLepton_charge.at(0) + RecoLepton_charge.at(1) + RecoLepton_charge.at(2))==1)*1.0")
                .Define("OnePair",     "((n_RecoElectrons==2 and n_RecoMuons==1 and (RecoElectron_charge.at(0) + RecoElectron_charge.at(1))==0) or (n_RecoElectrons==1 and n_RecoMuons==2 and (RecoMuon_charge.at(0) + RecoMuon_charge.at(1))==0))*1.0")
                ...
                .Define( "FCCAnalysesJets_ee_kt",  "JetClustering::clustering_ee_kt(2, 1, 1, 0)(pseudo_jets)" )
                .Define("Jets_kt1",  "JetClusteringUtils::get_pseudoJets( FCCAnalysesJets_ee_kt )")
                .Define("Jet_GetConstituents_kt1","JetClusteringUtils::get_constituents(FCCAnalysesJets_ee_kt)") # constituents indices
                .Define("Jets_Constituents_kt1", "JetConstituentsUtils::build_constituents_cluster(ReconstructedParticlesJET, Jet_GetConstituents_kt1)") #build jet constituents lists for tau reconstruction
                
		        .Define("Jets_kt1_e",      "JetClusteringUtils::get_e(Jets_kt1)")
                .Define("Jets_kt1_p",      "JetClusteringUtils::get_p(Jets_kt1)") #momentum p
                .Define("Jets_kt1_pt",      "JetClusteringUtils::get_pt(Jets_kt1)") #transverse momentum pt
                .Define("Jets_kt1_px",      "JetClusteringUtils::get_px(Jets_kt1)")
                .Define("Jets_kt1_py",      "JetClusteringUtils::get_py(Jets_kt1)")
                .Define("Jets_kt1_pz",      "JetClusteringUtils::get_pz(Jets_kt1)")
		        .Define("Jets_kt1_eta",     "JetClusteringUtils::get_eta(Jets_kt1)") #pseudorapidity eta
                .Define("Jets_kt1_theta",   "JetClusteringUtils::get_theta(Jets_kt1)")
		        .Define("Jets_kt1_phi",     "JetClusteringUtils::get_phi(Jets_kt1)") #polar angle in the transverse plane phi
                .Define("Jets_kt1_mass",      "JetClusteringUtils::get_m(Jets_kt1)")
                .Define("n_Jets_kt1_constituents",        "JetConstituentsUtils::get_n_constituents(Jets_Constituents_kt1)")
                .Define("n_Jets_kt1_charged_constituents",        "JetConstituentsUtils::get_ncharged_constituents(Jets_Constituents_kt1)")
                .Define("n_Jets_kt1_neutral_constituents",        "JetConstituentsUtils::get_nneutral_constituents(Jets_Constituents_kt1)")
                .Define("n_Jets_kt1", "Jets_kt1_e.size()")

                .Define("TauFromJet_kt1", "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt1, 0)") 
                ...
                .Define("Jets_kt1_sel_e",      "Jets_kt1_e[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_p",      "Jets_kt1_p[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_pt",      "Jets_kt1_pt[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_px",      "Jets_kt1_px[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_py",      "Jets_kt1_py[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_pz",      "Jets_kt1_pz[TauFromJet_kt1_type_sel<0 ]")
		        .Define("Jets_kt1_sel_eta",     "Jets_kt1_eta[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_theta",   "Jets_kt1_theta[TauFromJet_kt1_type_sel<0 ]")
		        .Define("Jets_kt1_sel_phi",     "Jets_kt1_phi[TauFromJet_kt1_type_sel<0 ]")
                .Define("Jets_kt1_sel_mass",      "Jets_kt1_mass[TauFromJet_kt1_type_sel<0 ]")
                .Define("n_Jets_kt1_sel", "Jets_kt1_sel_e.size()")

                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt1_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt1, 3)")
                ...
                .Define("NeutralTau_kt1_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt1, 4)")
                ...
                .Filter("n_TauFromJet_kt1==1 && n_Jets_kt1_sel==0") 
                ...
                .Filter("(TauFromJet_kt1_charge.at(0) + RecoLepton_charge.at(RecoZH_idx[2]))==0")
                ...
                .Define("RecoChargedTauTrack",   "ReconstructedParticle2Track::getRP2TRK(ChargedTau_kt1, EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(ChargedTau_kt1,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(ChargedTau_kt1,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(ChargedTau_kt1,EFlowTrack_1)") #significance
                .Define("RecoChargedTauTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(ChargedTau_kt1,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(ChargedTau_kt1,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(ChargedTau_kt1,EFlowTrack_1)")

                .Define("ChargedTauImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(ChargedTau_kt1_p4, RecoChargedTauTrack_D0, RecoChargedTauTrack_Z0)")
             
                .Define("RecoLeptonTrack",   "ReconstructedParticle2Track::getRP2TRK( ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])}, EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)")
                .Define("RecoLeptonTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)")
                .Define("RecoLeptonTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)") #significance
                .Define("RecoLeptonTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)")
                .Define("RecoLeptonTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)")
                .Define("RecoLeptonTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(ROOT::VecOps::RVec{RecoLeptons.at(RecoZH_idx[2])},EFlowTrack_1)")

                .Define("LeptonImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(ROOT::VecOps::RVec<TLorentzVector>{RecoLepton_p4.at(RecoZH_idx[2])}, RecoLeptonTrack_D0, RecoLeptonTrack_Z0)")
                ...
                .Define("RecoPiP_p4",       "if (ChargedTau_kt1_charge.at(0)==1) return ChargedTau_kt1_p4.at(0); else return RecoLepton_p4.at(RecoZH_idx[2]);")
                .Define("RecoPiM_p4",       "if (ChargedTau_kt1_charge.at(0)==1) return RecoLepton_p4.at(RecoZH_idx[2]); else return ChargedTau_kt1_p4.at(0);")
                ...
                .Define("RecoPi0P_p4",       "if (NeutralTau_kt1_charge.at(0)==1) return NeutralTau_kt1_p4.at(0); else return TLorentzVector(0.,0.,0.,0.);")
                .Define("RecoPi0M_p4",       "if (NeutralTau_kt1_charge.at(0)==1) return TLorentzVector(0.,0.,0.,0.); else return NeutralTau_kt1_p4.at(0);")
    ...
    def output():
        ...
        branchList = [
            ...
            "Jets_kt1_e",     
            "Jets_kt1_mass",   
            "n_Jets_kt1_constituents",   
            "n_Jets_kt1_charged_constituents",   
            "n_Jets_kt1_neutral_constituents",   
            "n_Jets_kt1",      
