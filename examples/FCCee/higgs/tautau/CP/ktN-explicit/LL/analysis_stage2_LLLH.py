...
class RDFanalysis():
    def analysers(df):
        ...
        df2 = (df2
                ...
                .Define("TauFromJet_kt1", "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 0)".format(jetClusteringHelper_kt1.constituents)) 
                ...
                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt1_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 1)".format(jetClusteringHelper_kt1.constituents))
                ...
                #get the neutral hadronic system for the tau jet, all in one "particle" variable, photons are kept separetely but would be related in pairs to pi0
                .Define("NeutralTau_kt1_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All({}, 2)".format(jetClusteringHelper_kt1.constituents))
