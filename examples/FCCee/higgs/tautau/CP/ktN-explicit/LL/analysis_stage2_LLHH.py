...
#inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsTauTau/ecm240/MCgenCP/DelphesPythia8_EDM4HEP/wMadspin/"
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("Jets_Constituents_kt2", "JetConstituentsUtils::build_constituents_cluster(ReconstructedParticlesJET, Jet_GetConstituents_kt2)") #build jet constituents lists for tau reconstruction
                ...
                .Define("TauFromJet_kt2", "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt2, 0)") 
                ...
                .Define("Jets_kt2_sel_e",      "Jets_kt2_e[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_p",      "Jets_kt2_p[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_pt",      "Jets_kt2_pt[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_px",      "Jets_kt2_px[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_py",      "Jets_kt2_py[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_pz",      "Jets_kt2_pz[TauFromJet_kt2_type_sel<0 ]")
		        .Define("Jets_kt2_sel_eta",     "Jets_kt2_eta[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_theta",   "Jets_kt2_theta[TauFromJet_kt2_type_sel<0 ]")
		        .Define("Jets_kt2_sel_phi",     "Jets_kt2_phi[TauFromJet_kt2_type_sel<0 ]")
                .Define("Jets_kt2_sel_mass",      "Jets_kt2_mass[TauFromJet_kt2_type_sel<0 ]")
                .Define("n_Jets_kt2_sel", "Jets_kt2_sel_e.size()")

                #get the leading charged particle in the tau jet, if only neutral particles are present then the particle is null
                .Define("ChargedTau_kt2_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt2, 3)")
                ...
                .Define("NeutralTau_kt2_all",      "FCCAnalyses::ZHfunctions::findTauInJet_All(Jets_Constituents_kt2, 4)")
        ...
        df2 = (df2
                ...
                .Filter("n_TauFromJet_kt2==2 && n_Jets_kt2_sel==0")
                ...
                .Define("RecoChargedTauTrack",   "ReconstructedParticle2Track::getRP2TRK(ChargedTau_kt2, EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0", "ReconstructedParticle2Track::getRP2TRK_D0(ChargedTau_kt2,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_Z0", "ReconstructedParticle2Track::getRP2TRK_Z0(ChargedTau_kt2,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_D0sig", "ReconstructedParticle2Track::getRP2TRK_D0_sig(ChargedTau_kt2,EFlowTrack_1)") #significance
                .Define("RecoChargedTauTrack_Z0sig", "ReconstructedParticle2Track::getRP2TRK_Z0_sig(ChargedTau_kt2,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_charge", "ReconstructedParticle2Track::getRP2TRK_charge(ChargedTau_kt2,EFlowTrack_1)")
                .Define("RecoChargedTauTrack_omega", "ReconstructedParticle2Track::getRP2TRK_omega(ChargedTau_kt2,EFlowTrack_1)")

                .Define("ChargedTauImpact_p4",     "FCCAnalyses::ZHfunctions::ImpactVector(ChargedTau_kt2_p4, RecoChargedTauTrack_D0, RecoChargedTauTrack_Z0)")

                ###########################
                ########### CP ############
                ###########################

                .Define("RecoDecayVertexObjectZ",   "VertexFitterSimple::VertexFitter_Tk( 0, RecoLeptonTrack)" ) ### reconstructing a vertex withour any request n=0 ###
                ...
                .Define("RecoPiP_p4",       "if (ChargedTau_kt2_charge.at(0)==1) return ChargedTau_kt2_p4.at(0); else return ChargedTau_kt2_p4.at(1);")
                .Define("RecoPiM_p4",       "if (ChargedTau_kt2_charge.at(0)==1) return ChargedTau_kt2_p4.at(1); else return ChargedTau_kt2_p4.at(0);")
                ...
                .Define("RecoPi0P_p4",       "if (NeutralTau_kt2_charge.at(0)==1) return NeutralTau_kt2_p4.at(0); else return NeutralTau_kt2_p4.at(1);")
                .Define("RecoPi0M_p4",       "if (NeutralTau_kt2_charge.at(0)==1) return NeutralTau_kt2_p4.at(1); else return NeutralTau_kt2_p4.at(0);")
