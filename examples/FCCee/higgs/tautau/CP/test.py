...
inputDir = "/ceph/xzuo/FCC_samples_alternative_detectors/ecm240/EDM4HEP/"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (df
                ...
                #.Define("Muon_p_res_0_20", "((FSGenMuon_p[FSGenMuon_p<=20.]-RecoMuon_p[FSGenMuon_p<=20.])/FSGenMuon_p[FSGenMuon_p<=20.])")
                #.Define("Muon_p_res_20_40", "((FSGenMuon_p[FSGenMuon_p>20. && FSGenMuon_p<=40.]-RecoMuon_p[FSGenMuon_p>20. && FSGenMuon_p<=40.])/FSGenMuon_p[FSGenMuon_p>20. && FSGenMuon_p<=40.])")
                #.Define("Muon_p_res_40_60", "((FSGenMuon_p[FSGenMuon_p>40. && FSGenMuon_p<=60.]-RecoMuon_p[FSGenMuon_p>40. && FSGenMuon_p<=60.])/FSGenMuon_p[FSGenMuon_p>40. && FSGenMuon_p<=60.])")
                #.Define("Muon_p_res_60_higher", "((FSGenMuon_p[FSGenMuon_p>60.]-RecoMuon_p[FSGenMuon_p>60.])/FSGenMuon_p[FSGenMuon_p>60.])") 
