...
DIRECTORIES = [
    ...
    "/afs/cern.ch/user/s/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/CP/ktN-explicit/",
]
SUBDIR = [
    'LL',
    'LH',
...
for dir in DIRECTORIES:
    for cat in CAT:
        ...
        for sub in SUBDIR:
            ...
            os.system(f"fccanalysis run {directory}/{cat}/analysis_stage2_{cat}{sub}.py")
