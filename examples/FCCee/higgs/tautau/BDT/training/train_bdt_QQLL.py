...
path = "/ceph/awiedl/FCCee/HiggsCP/stage2_100Coll150/QQ/LL/"

output_file = "/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/BDT/output_QQLL.txt"
...
if train_tree == True:
    ...
    # Save the figure
    fig.savefig("/web/awiedl/public_html/ML/BDT/QQLL_ROC_stage2_100Coll150.pdf")
    ...
    ROOT.TMVA.Experimental.SaveXGBoost(bdt, "Htautau", f"{out}/xgb_bdt_stage2_100Coll150_QQLL.root", num_inputs=len(vars_list))

    bdt.save_model(f"{out}/xgb_bdt_stage2_100Coll150_QQLL_model.json")
...
if full_test==True:
    ...
    bdt.load_model("xgb_bdt_stage2_QQLL_model.json")
    for q in bkgs:
        true_pred[q]=0
        false_pred[q]=0
        files = glob.glob(path+q+'/chunk_*.root')
