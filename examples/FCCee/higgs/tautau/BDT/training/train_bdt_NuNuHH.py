...
output_file = "/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/BDT/output_NuNuHH.txt"
...
if train_tree == True:
    ...
    # Save the figure
    fig.savefig("/web/awiedl/public_html/ML/BDT/NuNuHH_ROC_stage2_100Me.pdf")
