...
output_file = "/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/BDT/output_QQLH.txt"
...
if train_tree == True:
    ...
    # Save the figure
    fig.savefig("/web/awiedl/public_html/ML/BDT/QQLH_ROC_stage2_100Coll150.pdf")
