...
output_file = "/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/BDT/output_QQHH.txt"
...
if train_tree == True:
    ...
    # Save the figure
    fig.savefig("/web/awiedl/public_html/ML/BDT/QQHH_ROC_stage2_100Coll150.pdf")
...
if full_test==True:
    ...
    bdt.load_model("xgb_bdt_stage2_QQHH_model.json")
    for q in bkgs:
        true_pred[q]=0
        false_pred[q]=0
        files = glob.glob(path+q+'/chunk_*.root')
