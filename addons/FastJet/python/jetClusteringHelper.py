...
# add inclusive jet clustering
class InclusiveJetClusteringHelper:
    def __init__(self, coll, jetR, jetPt, tag=""):
        ...
        # ee_genkt (anti-kT here) R= jetR, inclusive, pt > jetPt, sort by E
        ...
        self.definition[_jet] = "JetClustering::clustering_ee_genkt({}, 0, {}, 1, 0, -1)({})".format(jetR, jetPt, pjetc)
